...
cs_0(7, "0.0.0.0"),
cs_1(2, "::");
static const unsigned char module_checksum[] = { 0xdc, 0xe2, 0xc8, 0x8d, 0xd4, 0x8e, 0x28, 0xc8, 0x04, 0x56, 0x0b, 0x44, 0x9e, 0xed, 0x34, 0x3f };
...
const TTCN_Typedescriptor_t ConnectionId_descr_ = { "@Socket_API_Definitions.ConnectionId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionId_xer_, &ConnectionId_json_, &ConnectionId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ro__ConnectionId
const TTCN_Typedescriptor_t ro__ConnectionId_descr_ = { "@Socket_API_Definitions.ro_ConnectionId", NULL, NULL, NULL, NULL, NULL, NULL, &ConnectionId_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ro__ConnectionId_0_xer_ = { {"ConnectionId>\n", "ConnectionId>\n"}, {14, 14}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ro__ConnectionId_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ro__ConnectionId_0_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ro__ConnectionId_0_descr_ = { "@Socket_API_Definitions.ro_ConnectionId.<oftype>", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ro__ConnectionId_0_xer_, &ro__ConnectionId_0_json_, &ro__ConnectionId_0_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t AssociationId_descr_ = { "@Socket_API_Definitions.AssociationId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &AssociationId_xer_, &AssociationId_json_, &AssociationId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ro__AssociationId
const TTCN_Typedescriptor_t ro__AssociationId_descr_ = { "@Socket_API_Definitions.ro_AssociationId", NULL, NULL, NULL, NULL, NULL, NULL, &AssociationId_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ro__AssociationId_0_xer_ = { {"AssociationId>\n", "AssociationId>\n"}, {15, 15}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ro__AssociationId_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ro__AssociationId_0_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ro__AssociationId_0_descr_ = { "@Socket_API_Definitions.ro_AssociationId.<oftype>", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ro__AssociationId_0_xer_, &ro__AssociationId_0_json_, &ro__AssociationId_0_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t HostName_descr_ = { "@Socket_API_Definitions.HostName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &HostName_xer_, &HostName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t PortNumber_descr_ = { "@Socket_API_Definitions.PortNumber", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &PortNumber_xer_, &PortNumber_json_, &PortNumber_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Socket_hostName_xer_ = { {"hostName>\n", "hostName>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Socket_hostName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Socket_hostName_descr_ = { "@Socket_API_Definitions.Socket.hostName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Socket_hostName_xer_, &Socket_hostName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Socket_portNumber_xer_ = { {"portNumber>\n", "portNumber>\n"}, {12, 12}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Socket_portNumber_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Socket_portNumber_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Socket_portNumber_descr_ = { "@Socket_API_Definitions.Socket.portNumber", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Socket_portNumber_xer_, &Socket_portNumber_json_, &Socket_portNumber_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Socket
const TTCN_Typedescriptor_t Socket_descr_ = { "@Socket_API_Definitions.Socket", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SocketList
const TTCN_Typedescriptor_t SocketList_descr_ = { "@Socket_API_Definitions.SocketList", NULL, NULL, NULL, NULL, NULL, NULL, &Socket_descr_, TTCN_Typedescriptor_t::DONTCARE };
...
// No XER for UdpTuple
const TTCN_Typedescriptor_t UdpTuple_descr_ = { "@Socket_API_Definitions.UdpTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for UdpLightTuple
const TTCN_Typedescriptor_t UdpLightTuple_descr_ = { "@Socket_API_Definitions.UdpLightTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for TcpTuple
const TTCN_Typedescriptor_t TcpTuple_descr_ = { "@Socket_API_Definitions.TcpTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpTuple
const TTCN_Typedescriptor_t SctpTuple_descr_ = { "@Socket_API_Definitions.SctpTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpTuple_sinfo__stream_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpTuple_sinfo__stream_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpTuple_sinfo__stream_descr_ = { "@Socket_API_Definitions.SctpTuple.sinfo_stream", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpTuple_sinfo__stream_xer_, &SctpTuple_sinfo__stream_json_, &SctpTuple_sinfo__stream_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpTuple_sinfo__ppid_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpTuple_sinfo__ppid_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpTuple_sinfo__ppid_descr_ = { "@Socket_API_Definitions.SctpTuple.sinfo_ppid", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpTuple_sinfo__ppid_xer_, &SctpTuple_sinfo__ppid_json_, &SctpTuple_sinfo__ppid_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpTuple_assocId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpTuple_assocId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpTuple_assocId_descr_ = { "@Socket_API_Definitions.SctpTuple.assocId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpTuple_assocId_xer_, &SctpTuple_assocId_json_, &SctpTuple_assocId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SslTuple
const TTCN_Typedescriptor_t SslTuple_descr_ = { "@Socket_API_Definitions.SslTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for DtlsTuple
const TTCN_Typedescriptor_t DtlsTuple_descr_ = { "@Socket_API_Definitions.DtlsTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for UnspecifiedTuple
const TTCN_Typedescriptor_t UnspecifiedTuple_descr_ = { "@Socket_API_Definitions.UnspecifiedTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ProtoTuple
const TTCN_Typedescriptor_t ProtoTuple_descr_ = { "@Socket_API_Definitions.ProtoTuple", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t UserData_descr_ = { "@Socket_API_Definitions.UserData", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &UserData_xer_, &UserData_json_, &UserData_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for PortError
const TTCN_Typedescriptor_t PortError_descr_ = { "@Socket_API_Definitions.PortError", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Result
const TTCN_Typedescriptor_t Result_descr_ = { "@Socket_API_Definitions.Result", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t Result_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Result_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Result_connId_descr_ = { "@Socket_API_Definitions.Result.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Result_connId_xer_, &Result_connId_json_, &Result_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t Result_os__error__code_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Result_os__error__code_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Result_os__error__code_descr_ = { "@Socket_API_Definitions.Result.os_error_code", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Result_os__error__code_xer_, &Result_os__error__code_json_, &Result_os__error__code_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Result_os__error__text_xer_ = { {"os_error_text>\n", "os_error_text>\n"}, {15, 15}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Result_os__error__text_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Result_os__error__text_descr_ = { "@Socket_API_Definitions.Result.os_error_text", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Result_os__error__text_xer_, &Result_os__error__text_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Extended__Result
const TTCN_Typedescriptor_t Extended__Result_descr_ = { "@Socket_API_Definitions.Extended_Result", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Extended__Result_connId_xer_ = { {"connId>\n", "connId>\n"}, {8, 8}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Extended__Result_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Extended__Result_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Extended__Result_connId_descr_ = { "@Socket_API_Definitions.Extended_Result.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Extended__Result_connId_xer_, &Extended__Result_connId_json_, &Extended__Result_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Extended__Result_os__error__code_xer_ = { {"os_error_code>\n", "os_error_code>\n"}, {15, 15}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Extended__Result_os__error__code_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Extended__Result_os__error__code_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Extended__Result_os__error__code_descr_ = { "@Socket_API_Definitions.Extended_Result.os_error_code", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Extended__Result_os__error__code_xer_, &Extended__Result_os__error__code_json_, &Extended__Result_os__error__code_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Extended__Result_os__error__text_xer_ = { {"os_error_text>\n", "os_error_text>\n"}, {15, 15}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Extended__Result_os__error__text_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Extended__Result_os__error__text_descr_ = { "@Socket_API_Definitions.Extended_Result.os_error_text", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Extended__Result_os__error__text_xer_, &Extended__Result_os__error__text_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t Extended__Result_msg_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Extended__Result_msg_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Extended__Result_msg_descr_ = { "@Socket_API_Definitions.Extended_Result.msg", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &Extended__Result_msg_xer_, &Extended__Result_msg_json_, &Extended__Result_msg_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ConnectionOpenedEvent_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_connId_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionOpenedEvent_connId_xer_, &ConnectionOpenedEvent_connId_json_, &ConnectionOpenedEvent_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_remName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_remName_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.remName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ConnectionOpenedEvent_remName_xer_, &ConnectionOpenedEvent_remName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ConnectionOpenedEvent_remPort_xer_ = { {"remPort>\n", "remPort>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_remPort_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ConnectionOpenedEvent_remPort_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_remPort_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.remPort", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionOpenedEvent_remPort_xer_, &ConnectionOpenedEvent_remPort_json_, &ConnectionOpenedEvent_remPort_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ConnectionOpenedEvent_locName_xer_ = { {"locName>\n", "locName>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_locName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_locName_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.locName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ConnectionOpenedEvent_locName_xer_, &ConnectionOpenedEvent_locName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ConnectionOpenedEvent_locPort_xer_ = { {"locPort>\n", "locPort>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_locPort_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ConnectionOpenedEvent_locPort_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_locPort_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.locPort", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionOpenedEvent_locPort_xer_, &ConnectionOpenedEvent_locPort_json_, &ConnectionOpenedEvent_locPort_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ConnectionOpenedEvent_userData_xer_ = { {"userData>\n", "userData>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ConnectionOpenedEvent_userData_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ConnectionOpenedEvent_userData_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ConnectionOpenedEvent_userData_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent.userData", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionOpenedEvent_userData_xer_, &ConnectionOpenedEvent_userData_json_, &ConnectionOpenedEvent_userData_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ConnectionOpenedEvent
const TTCN_Typedescriptor_t ConnectionOpenedEvent_descr_ = { "@Socket_API_Definitions.ConnectionOpenedEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const TTCN_Typedescriptor_t& ConnectionClosedEvent_descr_ = ConnectionOpenedEvent_descr_;
// No XER for SctpEvent
const TTCN_Typedescriptor_t SctpEvent_descr_ = { "@Socket_API_Definitions.SctpEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpAssocChange_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpAssocChange_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpAssocChange_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpAssocChange_clientId_descr_ = { "@Socket_API_Definitions.SctpAssocChange.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpAssocChange_clientId_xer_, &SctpAssocChange_clientId_json_, &SctpAssocChange_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SAC__STATE
const TTCN_Typedescriptor_t SAC__STATE_descr_ = { "@Socket_API_Definitions.SAC_STATE", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpAssocChange
const TTCN_Typedescriptor_t SctpAssocChange_descr_ = { "@Socket_API_Definitions.SctpAssocChange", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpPeerAddrChange_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpPeerAddrChange_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpPeerAddrChange_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpPeerAddrChange_clientId_descr_ = { "@Socket_API_Definitions.SctpPeerAddrChange.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpPeerAddrChange_clientId_xer_, &SctpPeerAddrChange_clientId_json_, &SctpPeerAddrChange_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SPC__STATE
const TTCN_Typedescriptor_t SPC__STATE_descr_ = { "@Socket_API_Definitions.SPC_STATE", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpPeerAddrChange
const TTCN_Typedescriptor_t SctpPeerAddrChange_descr_ = { "@Socket_API_Definitions.SctpPeerAddrChange", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpSendFailed_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpSendFailed_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpSendFailed_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpSendFailed_clientId_descr_ = { "@Socket_API_Definitions.SctpSendFailed.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpSendFailed_clientId_xer_, &SctpSendFailed_clientId_json_, &SctpSendFailed_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpSendFailed
const TTCN_Typedescriptor_t SctpSendFailed_descr_ = { "@Socket_API_Definitions.SctpSendFailed", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpRemoteError_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpRemoteError_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpRemoteError_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpRemoteError_clientId_descr_ = { "@Socket_API_Definitions.SctpRemoteError.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpRemoteError_clientId_xer_, &SctpRemoteError_clientId_json_, &SctpRemoteError_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpRemoteError
const TTCN_Typedescriptor_t SctpRemoteError_descr_ = { "@Socket_API_Definitions.SctpRemoteError", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpShutDownEvent_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpShutDownEvent_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpShutDownEvent_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpShutDownEvent_clientId_descr_ = { "@Socket_API_Definitions.SctpShutDownEvent.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpShutDownEvent_clientId_xer_, &SctpShutDownEvent_clientId_json_, &SctpShutDownEvent_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpShutDownEvent
const TTCN_Typedescriptor_t SctpShutDownEvent_descr_ = { "@Socket_API_Definitions.SctpShutDownEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpPartialDeliveryEvent_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpPartialDeliveryEvent_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpPartialDeliveryEvent_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpPartialDeliveryEvent_clientId_descr_ = { "@Socket_API_Definitions.SctpPartialDeliveryEvent.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpPartialDeliveryEvent_clientId_xer_, &SctpPartialDeliveryEvent_clientId_json_, &SctpPartialDeliveryEvent_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpPartialDeliveryEvent
const TTCN_Typedescriptor_t SctpPartialDeliveryEvent_descr_ = { "@Socket_API_Definitions.SctpPartialDeliveryEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpAdaptationIndication_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpAdaptationIndication_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpAdaptationIndication_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpAdaptationIndication_clientId_descr_ = { "@Socket_API_Definitions.SctpAdaptationIndication.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpAdaptationIndication_clientId_xer_, &SctpAdaptationIndication_clientId_json_, &SctpAdaptationIndication_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpAdaptationIndication
const TTCN_Typedescriptor_t SctpAdaptationIndication_descr_ = { "@Socket_API_Definitions.SctpAdaptationIndication", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpSenderDryEvent_clientId_xer_ = { {"clientId>\n", "clientId>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpSenderDryEvent_clientId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpSenderDryEvent_clientId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpSenderDryEvent_clientId_descr_ = { "@Socket_API_Definitions.SctpSenderDryEvent.clientId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &SctpSenderDryEvent_clientId_xer_, &SctpSenderDryEvent_clientId_json_, &SctpSenderDryEvent_clientId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpSenderDryEvent
const TTCN_Typedescriptor_t SctpSenderDryEvent_descr_ = { "@Socket_API_Definitions.SctpSenderDryEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for PortEvent
const TTCN_Typedescriptor_t PortEvent_descr_ = { "@Socket_API_Definitions.PortEvent", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ro__integer
const TTCN_Typedescriptor_t ro__integer_descr_ = { "@Socket_API_Definitions.ro_integer", NULL, NULL, NULL, NULL, NULL, NULL, &INTEGER_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ro__integer_0_xer_ = { {"INTEGER>\n", "INTEGER>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ro__integer_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ro__integer_0_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ro__integer_0_descr_ = { "@Socket_API_Definitions.ro_integer.INTEGER", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ro__integer_0_xer_, &ro__integer_0_json_, &ro__integer_0_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for f__getMsgLen
const TTCN_Typedescriptor_t f__getMsgLen_descr_ = { "@Socket_API_Definitions.f_getMsgLen", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ro__charstring
const TTCN_Typedescriptor_t ro__charstring_descr_ = { "@Socket_API_Definitions.ro_charstring", NULL, NULL, NULL, NULL, NULL, NULL, &CHARSTRING_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ro__charstring_0_xer_ = { {"CHARSTRING>\n", "CHARSTRING>\n"}, {12, 12}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ro__charstring_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ro__charstring_0_descr_ = { "@Socket_API_Definitions.ro_charstring.<oftype>", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ro__charstring_0_xer_, &ro__charstring_0_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
static void pre_init_module()
{
TTCN_Location current_location("Socket_API_Definitions.ttcn", 0, TTCN_Location::LOCATION_UNKNOWN, "Socket_API_Definitions");
current_location.update_lineno(50);
/* Socket_API_Definitions.ttcn, line 50 */
const_c__ipv4AnyAddr = cs_0;
current_location.update_lineno(51);
/* Socket_API_Definitions.ttcn, line 51 */
const_c__ipv6AnyAddr = cs_1;
current_location.update_lineno(52);
/* Socket_API_Definitions.ttcn, line 52 */
const_c__anyPort = 0;
current_location.update_lineno(53);
/* Socket_API_Definitions.ttcn, line 53 */
const_c__defaultLocAddr = cs_2;
current_location.update_lineno(54);
/* Socket_API_Definitions.ttcn, line 54 */
