...
static const unsigned char module_checksum[] = { 0x13, 0xa6, 0x1f, 0x7c, 0x67, 0x2b, 0x9f, 0x5e, 0xf4, 0xf3, 0xc6, 0x0f, 0x11, 0x77, 0xce, 0x1e };
...
const TTCN_JSONdescriptor_t ConnectionId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ConnectionId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ConnectionId_descr_ = { "@IPL4asp_Types.ConnectionId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ConnectionId_xer_, &ConnectionId_json_, &ConnectionId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t AssociationId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t AssociationId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t AssociationId_descr_ = { "@IPL4asp_Types.AssociationId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &AssociationId_xer_, &AssociationId_json_, &AssociationId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t HostName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t HostName_descr_ = { "@IPL4asp_Types.HostName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &HostName_xer_, &HostName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t PortNumber_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t PortNumber_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t PortNumber_descr_ = { "@IPL4asp_Types.PortNumber", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &PortNumber_xer_, &PortNumber_json_, &PortNumber_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t UserData_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t UserData_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t UserData_descr_ = { "@IPL4asp_Types.UserData", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &UserData_xer_, &UserData_json_, &UserData_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t TcpKeepAlive_descr_ = { "@IPL4asp_Types.TcpKeepAlive", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t TcpKeepAlive_enable_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t TcpKeepAlive_enable_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t TcpKeepAlive_enable_descr_ = { "@IPL4asp_Types.TcpKeepAlive.enable", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &TcpKeepAlive_enable_xer_, &TcpKeepAlive_enable_json_, &TcpKeepAlive_enable_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t TcpKeepAlive_count_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t TcpKeepAlive_count_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t TcpKeepAlive_count_descr_ = { "@IPL4asp_Types.TcpKeepAlive.count", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &TcpKeepAlive_count_xer_, &TcpKeepAlive_count_json_, &TcpKeepAlive_count_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t TcpKeepAlive_idle_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t TcpKeepAlive_idle_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t TcpKeepAlive_idle_descr_ = { "@IPL4asp_Types.TcpKeepAlive.idle", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &TcpKeepAlive_idle_xer_, &TcpKeepAlive_idle_json_, &TcpKeepAlive_idle_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t TcpKeepAlive_interval_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t TcpKeepAlive_interval_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t TcpKeepAlive_interval_descr_ = { "@IPL4asp_Types.TcpKeepAlive.interval", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &TcpKeepAlive_interval_xer_, &TcpKeepAlive_interval_json_, &TcpKeepAlive_interval_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ReuseAddress
const TTCN_Typedescriptor_t ReuseAddress_descr_ = { "@IPL4asp_Types.ReuseAddress", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ReuseAddress_enable_xer_ = { {"enable>\n", "enable>\n"}, {8, 8}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ReuseAddress_enable_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ReuseAddress_enable_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ReuseAddress_enable_descr_ = { "@IPL4asp_Types.ReuseAddress.enable", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &ReuseAddress_enable_xer_, &ReuseAddress_enable_json_, &ReuseAddress_enable_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SctpEventHandle
const TTCN_Typedescriptor_t SctpEventHandle_descr_ = { "@IPL4asp_Types.SctpEventHandle", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__data__io__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__data__io__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__data__io__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_data_io_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__data__io__event_xer_, &SctpEventHandle_sctp__data__io__event_json_, &SctpEventHandle_sctp__data__io__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__association__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__association__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__association__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_association_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__association__event_xer_, &SctpEventHandle_sctp__association__event_json_, &SctpEventHandle_sctp__association__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpEventHandle_sctp__address__event_xer_ = { {"sctp_address_event>\n", "sctp_address_event>\n"}, {20, 20}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__address__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__address__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__address__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_address_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__address__event_xer_, &SctpEventHandle_sctp__address__event_json_, &SctpEventHandle_sctp__address__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__send__failure__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__send__failure__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__send__failure__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_send_failure_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__send__failure__event_xer_, &SctpEventHandle_sctp__send__failure__event_json_, &SctpEventHandle_sctp__send__failure__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__peer__error__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__peer__error__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__peer__error__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_peer_error_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__peer__error__event_xer_, &SctpEventHandle_sctp__peer__error__event_json_, &SctpEventHandle_sctp__peer__error__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__shutdown__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__shutdown__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__shutdown__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_shutdown_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__shutdown__event_xer_, &SctpEventHandle_sctp__shutdown__event_json_, &SctpEventHandle_sctp__shutdown__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__partial__delivery__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__partial__delivery__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__partial__delivery__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_partial_delivery_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__partial__delivery__event_xer_, &SctpEventHandle_sctp__partial__delivery__event_json_, &SctpEventHandle_sctp__partial__delivery__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__adaptation__layer__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__adaptation__layer__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__adaptation__layer__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_adaptation_layer_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__adaptation__layer__event_xer_, &SctpEventHandle_sctp__adaptation__layer__event_json_, &SctpEventHandle_sctp__adaptation__layer__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__authentication__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__authentication__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__authentication__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_authentication_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__authentication__event_xer_, &SctpEventHandle_sctp__authentication__event_json_, &SctpEventHandle_sctp__authentication__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SctpEventHandle_sctp__sender__dry__event_xer_ = { {"sctp_sender_dry_event>\n", "sctp_sender_dry_event>\n"}, {23, 23}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SctpEventHandle_sctp__sender__dry__event_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SctpEventHandle_sctp__sender__dry__event_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SctpEventHandle_sctp__sender__dry__event_descr_ = { "@IPL4asp_Types.SctpEventHandle.sctp_sender_dry_event", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SctpEventHandle_sctp__sender__dry__event_xer_, &SctpEventHandle_sctp__sender__dry__event_json_, &SctpEventHandle_sctp__sender__dry__event_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t Linger__opt_l__onoff_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Linger__opt_l__onoff_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Linger__opt_l__onoff_descr_ = { "@IPL4asp_Types.Linger_opt.l_onoff", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Linger__opt_l__onoff_xer_, &Linger__opt_l__onoff_json_, &Linger__opt_l__onoff_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Linger__opt_l__linger_xer_ = { {"l_linger>\n", "l_linger>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Linger__opt_l__linger_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Linger__opt_l__linger_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Linger__opt_l__linger_descr_ = { "@IPL4asp_Types.Linger_opt.l_linger", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Linger__opt_l__linger_xer_, &Linger__opt_l__linger_json_, &Linger__opt_l__linger_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Linger__opt
const TTCN_Typedescriptor_t Linger__opt_descr_ = { "@IPL4asp_Types.Linger_opt", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SSL__protocols
const TTCN_Typedescriptor_t SSL__protocols_descr_ = { "@IPL4asp_Types.SSL_protocols", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__protocols_SSLv2__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_SSLv2__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_SSLv2__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.SSLv2_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_SSLv2__supported_xer_, &SSL__protocols_SSLv2__supported_json_, &SSL__protocols_SSLv2__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SSL__protocols_SSLv3__supported_xer_ = { {"SSLv3_supported>\n", "SSLv3_supported>\n"}, {17, 17}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SSL__protocols_SSLv3__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_SSLv3__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_SSLv3__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.SSLv3_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_SSLv3__supported_xer_, &SSL__protocols_SSLv3__supported_json_, &SSL__protocols_SSLv3__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SSL__protocols_TLSv1__supported_xer_ = { {"TLSv1_supported>\n", "TLSv1_supported>\n"}, {17, 17}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_TLSv1__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_TLSv1__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.TLSv1_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_TLSv1__supported_xer_, &SSL__protocols_TLSv1__supported_json_, &SSL__protocols_TLSv1__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__1__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_TLSv1__1__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_TLSv1__1__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.TLSv1_1_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_TLSv1__1__supported_xer_, &SSL__protocols_TLSv1__1__supported_json_, &SSL__protocols_TLSv1__1__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SSL__protocols_TLSv1__2__supported_xer_ = { {"TLSv1_2_supported>\n", "TLSv1_2_supported>\n"}, {19, 19}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__2__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_TLSv1__2__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_TLSv1__2__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.TLSv1_2_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_TLSv1__2__supported_xer_, &SSL__protocols_TLSv1__2__supported_json_, &SSL__protocols_TLSv1__2__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__protocols_DTLSv1__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_DTLSv1__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_DTLSv1__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.DTLSv1_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_DTLSv1__supported_xer_, &SSL__protocols_DTLSv1__supported_json_, &SSL__protocols_DTLSv1__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__protocols_DTLSv1__2__supported_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t SSL__protocols_DTLSv1__2__supported_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t SSL__protocols_DTLSv1__2__supported_descr_ = { "@IPL4asp_Types.SSL_protocols.DTLSv1_2_supported", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &SSL__protocols_DTLSv1__2__supported_xer_, &SSL__protocols_DTLSv1__2__supported_json_, &SSL__protocols_DTLSv1__2__supported_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SSL__proto__support
const TTCN_Typedescriptor_t SSL__proto__support_descr_ = { "@IPL4asp_Types.SSL_proto_support", NULL, NULL, NULL, NULL, NULL, NULL, &SSL__protocols_descr_, TTCN_Typedescriptor_t::DONTCARE };
// No XER for SSL__cert__options
const TTCN_Typedescriptor_t SSL__cert__options_descr_ = { "@IPL4asp_Types.SSL_cert_options", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__cert__options_ssl__key__file_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t SSL__cert__options_ssl__key__file_descr_ = { "@IPL4asp_Types.SSL_cert_options.ssl_key_file", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &SSL__cert__options_ssl__key__file_xer_, &SSL__cert__options_ssl__key__file_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__cert__options_ssl__certificate__file_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t SSL__cert__options_ssl__certificate__file_descr_ = { "@IPL4asp_Types.SSL_cert_options.ssl_certificate_file", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &SSL__cert__options_ssl__certificate__file_xer_, &SSL__cert__options_ssl__certificate__file_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SSL__cert__options_ssl__trustedCAlist__file_xer_ = { {"ssl_trustedCAlist_file>\n", "ssl_trustedCAlist_file>\n"}, {24, 24}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SSL__cert__options_ssl__trustedCAlist__file_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t SSL__cert__options_ssl__trustedCAlist__file_descr_ = { "@IPL4asp_Types.SSL_cert_options.ssl_trustedCAlist_file", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &SSL__cert__options_ssl__trustedCAlist__file_xer_, &SSL__cert__options_ssl__trustedCAlist__file_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t SSL__cert__options_ssl__cipher__list_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t SSL__cert__options_ssl__cipher__list_descr_ = { "@IPL4asp_Types.SSL_cert_options.ssl_cipher_list", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &SSL__cert__options_ssl__cipher__list_xer_, &SSL__cert__options_ssl__cipher__list_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       SSL__cert__options_ssl__password_xer_ = { {"ssl_password>\n", "ssl_password>\n"}, {14, 14}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t SSL__cert__options_ssl__password_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t SSL__cert__options_ssl__password_descr_ = { "@IPL4asp_Types.SSL_cert_options.ssl_password", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &SSL__cert__options_ssl__password_xer_, &SSL__cert__options_ssl__password_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for PSK__options
const TTCN_Typedescriptor_t PSK__options_descr_ = { "@IPL4asp_Types.PSK_options", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       PSK__options_psk__identity_xer_ = { {"psk_identity>\n", "psk_identity>\n"}, {14, 14}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t PSK__options_psk__identity_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t PSK__options_psk__identity_descr_ = { "@IPL4asp_Types.PSK_options.psk_identity", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &PSK__options_psk__identity_xer_, &PSK__options_psk__identity_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       PSK__options_psk__identity__hint_xer_ = { {"psk_identity_hint>\n", "psk_identity_hint>\n"}, {19, 19}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t PSK__options_psk__identity__hint_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t PSK__options_psk__identity__hint_descr_ = { "@IPL4asp_Types.PSK_options.psk_identity_hint", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &PSK__options_psk__identity__hint_xer_, &PSK__options_psk__identity__hint_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       PSK__options_psk__key_xer_ = { {"psk_key>\n", "psk_key>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED |XER_OPTIONAL, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t PSK__options_psk__key_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t PSK__options_psk__key_descr_ = { "@IPL4asp_Types.PSK_options.psk_key", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &PSK__options_psk__key_xer_, &PSK__options_psk__key_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for MTU__discover
const TTCN_Typedescriptor_t MTU__discover_descr_ = { "@IPL4asp_Types.MTU_discover", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Option
const TTCN_Typedescriptor_t Option_descr_ = { "@IPL4asp_Types.Option", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for HostList
const TTCN_Typedescriptor_t HostList_descr_ = { "@IPL4asp_Types.HostList", NULL, NULL, NULL, NULL, NULL, NULL, &HostName_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       HostList_0_xer_ = { {"HostName>\n", "HostName>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t HostList_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t HostList_0_descr_ = { "@IPL4asp_Types.HostList.<oftype>", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &HostList_0_xer_, &HostList_0_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_sctpEINConfigGroup_xer_ = { {"sctpEINConfigGroup>\n", "sctpEINConfigGroup>\n"}, {20, 20}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_sctpEINConfigGroup_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Option_sctpEINConfigGroup_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Option_sctpEINConfigGroup_descr_ = { "@IPL4asp_Types.Option.sctpEINConfigGroup", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Option_sctpEINConfigGroup_xer_, &Option_sctpEINConfigGroup_json_, &Option_sctpEINConfigGroup_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_no__delay_xer_ = { {"no_delay>\n", "no_delay>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_no__delay_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Option_no__delay_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Option_no__delay_descr_ = { "@IPL4asp_Types.Option.no_delay", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &Option_no__delay_xer_, &Option_no__delay_json_, &Option_no__delay_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_dtlsSrtpProfiles_xer_ = { {"dtlsSrtpProfiles>\n", "dtlsSrtpProfiles>\n"}, {18, 18}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_dtlsSrtpProfiles_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Option_dtlsSrtpProfiles_descr_ = { "@IPL4asp_Types.Option.dtlsSrtpProfiles", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Option_dtlsSrtpProfiles_xer_, &Option_dtlsSrtpProfiles_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_freebind_xer_ = { {"freebind>\n", "freebind>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_freebind_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Option_freebind_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Option_freebind_descr_ = { "@IPL4asp_Types.Option.freebind", &BOOLEAN_ber_, &BOOLEAN_raw_, &BOOLEAN_text_, &Option_freebind_xer_, &Option_freebind_json_, &Option_freebind_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for Option_alpn__list
const TTCN_Typedescriptor_t Option_alpn__list_descr_ = { "@IPL4asp_Types.Option.alpn_list", NULL, NULL, NULL, NULL, NULL, NULL, &CHARSTRING_descr_, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_alpn__list_0_xer_ = { {"CHARSTRING>\n", "CHARSTRING>\n"}, {12, 12}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_alpn__list_0_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Option_alpn__list_0_descr_ = { "@IPL4asp_Types.Option.alpn_list.<oftype>", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Option_alpn__list_0_xer_, &Option_alpn__list_0_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_tls__hostname_xer_ = { {"tls_hostname>\n", "tls_hostname>\n"}, {14, 14}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_tls__hostname_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t Option_tls__hostname_descr_ = { "@IPL4asp_Types.Option.tls_hostname", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &Option_tls__hostname_xer_, &Option_tls__hostname_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for UDP__ENCAP__Param
const TTCN_Typedescriptor_t UDP__ENCAP__Param_descr_ = { "@IPL4asp_Types.UDP_ENCAP_Param", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       Option_dscp_xer_ = { {"dscp>\n", "dscp>\n"}, {6, 6}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t Option_dscp_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t Option_dscp_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t Option_dscp_descr_ = { "@IPL4asp_Types.Option.dscp", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &Option_dscp_xer_, &Option_dscp_json_, &Option_dscp_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for OptionList
const TTCN_Typedescriptor_t OptionList_descr_ = { "@IPL4asp_Types.OptionList", NULL, NULL, NULL, NULL, NULL, NULL, &Option_descr_, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t ASP__Send_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__Send_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__Send_connId_descr_ = { "@IPL4asp_Types.ASP_Send.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__Send_connId_xer_, &ASP__Send_connId_json_, &ASP__Send_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t ASP__Send_msg_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__Send_msg_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__Send_msg_descr_ = { "@IPL4asp_Types.ASP_Send.msg", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &ASP__Send_msg_xer_, &ASP__Send_msg_json_, &ASP__Send_msg_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ASP__Send
const TTCN_Typedescriptor_t ASP__Send_descr_ = { "@IPL4asp_Types.ASP_Send", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__SendTo_connId_xer_ = { {"connId>\n", "connId>\n"}, {8, 8}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__SendTo_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__SendTo_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__SendTo_connId_descr_ = { "@IPL4asp_Types.ASP_SendTo.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__SendTo_connId_xer_, &ASP__SendTo_connId_json_, &ASP__SendTo_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__SendTo_remName_xer_ = { {"remName>\n", "remName>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__SendTo_remName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ASP__SendTo_remName_descr_ = { "@IPL4asp_Types.ASP_SendTo.remName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ASP__SendTo_remName_xer_, &ASP__SendTo_remName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__SendTo_remPort_xer_ = { {"remPort>\n", "remPort>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__SendTo_remPort_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__SendTo_remPort_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__SendTo_remPort_descr_ = { "@IPL4asp_Types.ASP_SendTo.remPort", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__SendTo_remPort_xer_, &ASP__SendTo_remPort_json_, &ASP__SendTo_remPort_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__SendTo_msg_xer_ = { {"msg>\n", "msg>\n"}, {5, 5}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__SendTo_msg_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__SendTo_msg_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__SendTo_msg_descr_ = { "@IPL4asp_Types.ASP_SendTo.msg", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &ASP__SendTo_msg_xer_, &ASP__SendTo_msg_json_, &ASP__SendTo_msg_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ASP__SendTo
const TTCN_Typedescriptor_t ASP__SendTo_descr_ = { "@IPL4asp_Types.ASP_SendTo", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_connId_xer_ = { {"connId>\n", "connId>\n"}, {8, 8}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__RecvFrom_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_connId_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__RecvFrom_connId_xer_, &ASP__RecvFrom_connId_json_, &ASP__RecvFrom_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_remName_xer_ = { {"remName>\n", "remName>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_remName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_remName_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.remName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ASP__RecvFrom_remName_xer_, &ASP__RecvFrom_remName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_remPort_xer_ = { {"remPort>\n", "remPort>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_remPort_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__RecvFrom_remPort_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_remPort_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.remPort", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__RecvFrom_remPort_xer_, &ASP__RecvFrom_remPort_json_, &ASP__RecvFrom_remPort_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_locName_xer_ = { {"locName>\n", "locName>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_locName_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_locName_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.locName", NULL, &CHARSTRING_raw_, &CHARSTRING_text_, &ASP__RecvFrom_locName_xer_, &ASP__RecvFrom_locName_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_locPort_xer_ = { {"locPort>\n", "locPort>\n"}, {9, 9}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_locPort_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__RecvFrom_locPort_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_locPort_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.locPort", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__RecvFrom_locPort_xer_, &ASP__RecvFrom_locPort_json_, &ASP__RecvFrom_locPort_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_userData_xer_ = { {"userData>\n", "userData>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_userData_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__RecvFrom_userData_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_userData_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.userData", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__RecvFrom_userData_xer_, &ASP__RecvFrom_userData_json_, &ASP__RecvFrom_userData_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       ASP__RecvFrom_msg_xer_ = { {"msg>\n", "msg>\n"}, {5, 5}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__RecvFrom_msg_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__RecvFrom_msg_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__RecvFrom_msg_descr_ = { "@IPL4asp_Types.ASP_RecvFrom.msg", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &ASP__RecvFrom_msg_xer_, &ASP__RecvFrom_msg_json_, &ASP__RecvFrom_msg_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ASP__RecvFrom
const TTCN_Typedescriptor_t ASP__RecvFrom_descr_ = { "@IPL4asp_Types.ASP_RecvFrom", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const TTCN_Typedescriptor_t& ASP__Event_descr_ = Socket__API__Definitions::PortEvent_descr_;
const XERdescriptor_t       ASP__ConnId__ReadyToRelease_connId_xer_ = { {"connId>\n", "connId>\n"}, {8, 8}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t ASP__ConnId__ReadyToRelease_connId_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t ASP__ConnId__ReadyToRelease_connId_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t ASP__ConnId__ReadyToRelease_connId_descr_ = { "@IPL4asp_Types.ASP_ConnId_ReadyToRelease.connId", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &ASP__ConnId__ReadyToRelease_connId_xer_, &ASP__ConnId__ReadyToRelease_connId_json_, &ASP__ConnId__ReadyToRelease_connId_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for ASP__ConnId__ReadyToRelease
const TTCN_Typedescriptor_t ASP__ConnId__ReadyToRelease_descr_ = { "@IPL4asp_Types.ASP_ConnId_ReadyToRelease", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_Typedescriptor_t IPL4__Param_descr_ = { "@IPL4asp_Types.IPL4_Param", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for IPL4__ParamResult
const TTCN_Typedescriptor_t IPL4__ParamResult_descr_ = { "@IPL4asp_Types.IPL4_ParamResult", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       IPL4__ParamResult_userData_xer_ = { {"userData>\n", "userData>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t IPL4__ParamResult_userData_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__ParamResult_userData_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__ParamResult_userData_descr_ = { "@IPL4asp_Types.IPL4_ParamResult.userData", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &IPL4__ParamResult_userData_xer_, &IPL4__ParamResult_userData_json_, &IPL4__ParamResult_userData_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
const TTCN_JSONdescriptor_t IPL4__ParamResult_parentIdx_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__ParamResult_parentIdx_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__ParamResult_parentIdx_descr_ = { "@IPL4asp_Types.IPL4_ParamResult.parentIdx", &INTEGER_ber_, &INTEGER_raw_, &INTEGER_text_, &IPL4__ParamResult_parentIdx_xer_, &IPL4__ParamResult_parentIdx_json_, &IPL4__ParamResult_parentIdx_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for IPL4__IPAddressType
const TTCN_Typedescriptor_t IPL4__IPAddressType_descr_ = { "@IPL4asp_Types.IPL4_IPAddressType", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       IPL4__SrtpKeysAndSalts_localKey_xer_ = { {"localKey>\n", "localKey>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_localKey_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_localKey_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__SrtpKeysAndSalts_localKey_descr_ = { "@IPL4asp_Types.IPL4_SrtpKeysAndSalts.localKey", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &IPL4__SrtpKeysAndSalts_localKey_xer_, &IPL4__SrtpKeysAndSalts_localKey_json_, &IPL4__SrtpKeysAndSalts_localKey_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       IPL4__SrtpKeysAndSalts_remoteKey_xer_ = { {"remoteKey>\n", "remoteKey>\n"}, {11, 11}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_remoteKey_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_remoteKey_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__SrtpKeysAndSalts_remoteKey_descr_ = { "@IPL4asp_Types.IPL4_SrtpKeysAndSalts.remoteKey", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &IPL4__SrtpKeysAndSalts_remoteKey_xer_, &IPL4__SrtpKeysAndSalts_remoteKey_json_, &IPL4__SrtpKeysAndSalts_remoteKey_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       IPL4__SrtpKeysAndSalts_localSalt_xer_ = { {"localSalt>\n", "localSalt>\n"}, {11, 11}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_localSalt_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_localSalt_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__SrtpKeysAndSalts_localSalt_descr_ = { "@IPL4asp_Types.IPL4_SrtpKeysAndSalts.localSalt", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &IPL4__SrtpKeysAndSalts_localSalt_xer_, &IPL4__SrtpKeysAndSalts_localSalt_json_, &IPL4__SrtpKeysAndSalts_localSalt_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const XERdescriptor_t       IPL4__SrtpKeysAndSalts_remoteSalt_xer_ = { {"remoteSalt>\n", "remoteSalt>\n"}, {12, 12}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL, -1, XSD_NONE };
const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_remoteSalt_json_ = { FALSE, NULL, FALSE, NULL, FALSE, FALSE };
const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_remoteSalt_oer_ = { -1, FALSE, -1, FALSE };
const TTCN_Typedescriptor_t IPL4__SrtpKeysAndSalts_remoteSalt_descr_ = { "@IPL4asp_Types.IPL4_SrtpKeysAndSalts.remoteSalt", &OCTETSTRING_ber_, &OCTETSTRING_raw_, &OCTETSTRING_text_, &IPL4__SrtpKeysAndSalts_remoteSalt_xer_, &IPL4__SrtpKeysAndSalts_remoteSalt_json_, &IPL4__SrtpKeysAndSalts_remoteSalt_oer_, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for IPL4__SrtpKeysAndSalts
const TTCN_Typedescriptor_t IPL4__SrtpKeysAndSalts_descr_ = { "@IPL4asp_Types.IPL4_SrtpKeysAndSalts", NULL, NULL, NULL, NULL, NULL, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
// No XER for IPL4__DigestMethods
const TTCN_Typedescriptor_t IPL4__DigestMethods_descr_ = { "@IPL4asp_Types.IPL4_DigestMethods", NULL, NULL, NULL, NULL, &ENUMERATED_json_, NULL, NULL, TTCN_Typedescriptor_t::DONTCARE };
...
PSK__options::PSK__options()
{
}

PSK__options::PSK__options(const OPTIONAL<CHARSTRING>& par_psk__identity,
    const OPTIONAL<CHARSTRING>& par_psk__identity__hint,
    const OPTIONAL<CHARSTRING>& par_psk__key)
  :   field_psk__identity(par_psk__identity),
  field_psk__identity__hint(par_psk__identity__hint),
  field_psk__key(par_psk__key)
{
}

PSK__options::PSK__options(const PSK__options& other_value)
{
if(!other_value.is_bound()) TTCN_error("Copying an unbound value of type @IPL4asp_Types.PSK_options.");
if (other_value.psk__identity().is_bound()) field_psk__identity = other_value.psk__identity();
else field_psk__identity.clean_up();
if (other_value.psk__identity__hint().is_bound()) field_psk__identity__hint = other_value.psk__identity__hint();
else field_psk__identity__hint.clean_up();
if (other_value.psk__key().is_bound()) field_psk__key = other_value.psk__key();
else field_psk__key.clean_up();
}

void PSK__options::clean_up()
{
field_psk__identity.clean_up();
field_psk__identity__hint.clean_up();
field_psk__key.clean_up();
}

PSK__options& PSK__options::operator=(const PSK__options& other_value)
{
if (this != &other_value) {
  if(!other_value.is_bound()) TTCN_error("Assignment of an unbound value of type @IPL4asp_Types.PSK_options.");
  if (other_value.psk__identity().is_bound()) field_psk__identity = other_value.psk__identity();
  else field_psk__identity.clean_up();
  if (other_value.psk__identity__hint().is_bound()) field_psk__identity__hint = other_value.psk__identity__hint();
  else field_psk__identity__hint.clean_up();
...
boolean PSK__options::operator==(const PSK__options& other_value) const
{
return field_psk__identity==other_value.field_psk__identity
  && field_psk__identity__hint==other_value.field_psk__identity__hint
  && field_psk__key==other_value.field_psk__key;
}

boolean PSK__options::is_bound() const
{
if(OPTIONAL_OMIT == field_psk__identity.get_selection() || field_psk__identity.is_bound()) return TRUE;
if(OPTIONAL_OMIT == field_psk__identity__hint.get_selection() || field_psk__identity__hint.is_bound()) return TRUE;
if(OPTIONAL_OMIT == field_psk__key.get_selection() || field_psk__key.is_bound()) return TRUE;
return FALSE;
}
boolean PSK__options::is_value() const
{
if(OPTIONAL_OMIT != field_psk__identity.get_selection() && !field_psk__identity.is_value()) return FALSE;
if(OPTIONAL_OMIT != field_psk__identity__hint.get_selection() && !field_psk__identity__hint.is_value()) return FALSE;
if(OPTIONAL_OMIT != field_psk__key.get_selection() && !field_psk__key.is_value()) return FALSE;
return TRUE;
}
int PSK__options::size_of() const
{
  int ret_val = 0;
  if (field_psk__identity.ispresent()) ret_val++;
  if (field_psk__identity__hint.ispresent()) ret_val++;
  if (field_psk__key.ispresent()) ret_val++;
  return ret_val;
}

void PSK__options::log() const
{
if (!is_bound()) {
TTCN_Logger::log_event_unbound();
return;
...
field_psk__identity.log();
TTCN_Logger::log_event_str(", psk_identity_hint := ");
field_psk__identity__hint.log();
TTCN_Logger::log_event_str(", psk_key := ");
field_psk__key.log();
TTCN_Logger::log_event_str(" }");
}

void PSK__options::set_param(Module_Param& param)
{
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
    if (3<param.get_size()) {
      param.error("record value of type @IPL4asp_Types.PSK_options has 3 fields but list value has %d fields", (int)param.get_size());
    }
    if (param.get_size()>0 && param.get_elem(0)->get_type()!=Module_Param::MP_NotUsed) psk__identity().set_param(*param.get_elem(0));
    if (param.get_size()>1 && param.get_elem(1)->get_type()!=Module_Param::MP_NotUsed) psk__identity__hint().set_param(*param.get_elem(1));
    if (param.get_size()>2 && param.get_elem(2)->get_type()!=Module_Param::MP_NotUsed) psk__key().set_param(*param.get_elem(2));
    break;
  case Module_Param::MP_Assignment_List: {
    Vector<bool> value_used(param.get_size());
    value_used.resize(param.get_size(), FALSE);
    for (size_t val_idx=0; val_idx<param.get_size(); val_idx++) {
      Module_Param* const curr_param = param.get_elem(val_idx);
      if (!strcmp(curr_param->get_id()->get_name(), "psk_identity")) {
        if (curr_param->get_type()!=Module_Param::MP_NotUsed) {
          psk__identity().set_param(*curr_param);
        }
        value_used[val_idx]=TRUE;
      }
    }
    for (size_t val_idx=0; val_idx<param.get_size(); val_idx++) {
      Module_Param* const curr_param = param.get_elem(val_idx);
      if (!strcmp(curr_param->get_id()->get_name(), "psk_identity_hint")) {
        if (curr_param->get_type()!=Module_Param::MP_NotUsed) {
          psk__identity__hint().set_param(*curr_param);
        }
        value_used[val_idx]=TRUE;
      }
    }
    for (size_t val_idx=0; val_idx<param.get_size(); val_idx++) {
      Module_Param* const curr_param = param.get_elem(val_idx);
      if (!strcmp(curr_param->get_id()->get_name(), "psk_key")) {
        if (curr_param->get_type()!=Module_Param::MP_NotUsed) {
          psk__key().set_param(*curr_param);
        }
        value_used[val_idx]=TRUE;
      }
    }
    for (size_t val_idx=0; val_idx<param.get_size(); val_idx++) if (!value_used[val_idx]) {
      param.get_elem(val_idx)->error("Non existent field name in type @IPL4asp_Types.PSK_options: %s", param.get_elem(val_idx)->get_id()->get_name());
      break;
    }
  } break;
  default:
...
void PSK__options::set_implicit_omit()
{
if (!psk__identity().is_bound()) psk__identity() = OMIT_VALUE;
else psk__identity().set_implicit_omit();
if (!psk__identity__hint().is_bound()) psk__identity__hint() = OMIT_VALUE;
else psk__identity__hint().set_implicit_omit();
if (!psk__key().is_bound()) psk__key() = OMIT_VALUE;
else psk__key().set_implicit_omit();
}

void PSK__options::encode_text(Text_Buf& text_buf) const
{
field_psk__identity.encode_text(text_buf);
field_psk__identity__hint.encode_text(text_buf);
field_psk__key.encode_text(text_buf);
}

void PSK__options::decode_text(Text_Buf& text_buf)
{
field_psk__identity.decode_text(text_buf);
field_psk__identity__hint.decode_text(text_buf);
field_psk__key.decode_text(text_buf);
}

struct PSK__options_template::single_value_struct {
CHARSTRING_template field_psk__identity;
CHARSTRING_template field_psk__identity__hint;
CHARSTRING_template field_psk__key;
};

void PSK__options_template::set_specific()
{
if (template_selection != SPECIFIC_VALUE) {
template_sel old_selection = template_selection;
clean_up();
...
set_selection(SPECIFIC_VALUE);
if (old_selection == ANY_VALUE || old_selection == ANY_OR_OMIT) {
single_value->field_psk__identity = ANY_OR_OMIT;
single_value->field_psk__identity__hint = ANY_OR_OMIT;
single_value->field_psk__key = ANY_OR_OMIT;
}
}
}

void PSK__options_template::copy_value(const PSK__options& other_value)
{
single_value = new single_value_struct;
if (other_value.psk__identity().is_bound()) {
  if (other_value.psk__identity().ispresent()) single_value->field_psk__identity = other_value.psk__identity()();
  else single_value->field_psk__identity = OMIT_VALUE;
} else {
  single_value->field_psk__identity.clean_up();
}
if (other_value.psk__identity__hint().is_bound()) {
  if (other_value.psk__identity__hint().ispresent()) single_value->field_psk__identity__hint = other_value.psk__identity__hint()();
  else single_value->field_psk__identity__hint = OMIT_VALUE;
} else {
  single_value->field_psk__identity__hint.clean_up();
}
if (other_value.psk__key().is_bound()) {
  if (other_value.psk__key().ispresent()) single_value->field_psk__key = other_value.psk__key()();
  else single_value->field_psk__key = OMIT_VALUE;
} else {
  single_value->field_psk__key.clean_up();
}
set_selection(SPECIFIC_VALUE);
}

void PSK__options_template::copy_template(const PSK__options_template& other_value)
{
switch (other_value.template_selection) {
case SPECIFIC_VALUE:
single_value = new single_value_struct;
if (UNINITIALIZED_TEMPLATE != other_value.psk__identity().get_selection()) {
single_value->field_psk__identity = other_value.psk__identity();
} else {
single_value->field_psk__identity.clean_up();
}
if (UNINITIALIZED_TEMPLATE != other_value.psk__identity__hint().get_selection()) {
single_value->field_psk__identity__hint = other_value.psk__identity__hint();
} else {
single_value->field_psk__identity__hint.clean_up();
}
if (UNINITIALIZED_TEMPLATE != other_value.psk__key().get_selection()) {
single_value->field_psk__key = other_value.psk__key();
} else {
single_value->field_psk__key.clean_up();
}
case OMIT_VALUE:
...
case COMPLEMENTED_LIST:
value_list.n_values = other_value.value_list.n_values;
value_list.list_value = new PSK__options_template[value_list.n_values];
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
value_list.list_value[list_count].copy_template(other_value.value_list.list_value[list_count]);
break;
default:
TTCN_error("Copying an uninitialized/unsupported template of type @IPL4asp_Types.PSK_options.");
break;
}
set_selection(other_value);
}

PSK__options_template::PSK__options_template()
{
}

PSK__options_template::PSK__options_template(template_sel other_value)
 : Base_Template(other_value)
{
check_single_selection(other_value);
}

PSK__options_template::PSK__options_template(const PSK__options& other_value)
{
copy_value(other_value);
}

PSK__options_template::PSK__options_template(const OPTIONAL<PSK__options>& other_value)
{
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
copy_value((const PSK__options&)other_value);
break;
case OPTIONAL_OMIT:
set_selection(OMIT_VALUE);
break;
default:
TTCN_error("Creating a template of type @IPL4asp_Types.PSK_options from an unbound optional field.");
}
}

PSK__options_template::PSK__options_template(const PSK__options_template& other_value)
: Base_Template()
{
copy_template(other_value);
}
...
PSK__options_template& PSK__options_template::operator=(template_sel other_value)
{
check_single_selection(other_value);
clean_up();
set_selection(other_value);
...
PSK__options_template& PSK__options_template::operator=(const PSK__options& other_value)
{
clean_up();
copy_value(other_value);
return *this;
...
PSK__options_template& PSK__options_template::operator=(const OPTIONAL<PSK__options>& other_value)
{
clean_up();
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
...
break;
default:
TTCN_error("Assignment of an unbound optional field to a template of type @IPL4asp_Types.PSK_options.");
}
return *this;
}

PSK__options_template& PSK__options_template::operator=(const PSK__options_template& other_value)
{
if (&other_value != this) {
clean_up();
copy_template(other_value);
...
boolean PSK__options_template::match(const PSK__options& other_value, boolean legacy) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
return FALSE;
case SPECIFIC_VALUE:
if(!other_value.psk__identity().is_bound()) return FALSE;
if((other_value.psk__identity().ispresent() ? !single_value->field_psk__identity.match((const CHARSTRING&)other_value.psk__identity(), legacy) : !single_value->field_psk__identity.match_omit(legacy)))return FALSE;
if(!other_value.psk__identity__hint().is_bound()) return FALSE;
if((other_value.psk__identity__hint().ispresent() ? !single_value->field_psk__identity__hint.match((const CHARSTRING&)other_value.psk__identity__hint(), legacy) : !single_value->field_psk__identity__hint.match_omit(legacy)))return FALSE;
if(!other_value.psk__key().is_bound()) return FALSE;
if((other_value.psk__key().ispresent() ? !single_value->field_psk__key.match((const CHARSTRING&)other_value.psk__key(), legacy) : !single_value->field_psk__key.match_omit(legacy)))return FALSE;
return TRUE;
case VALUE_LIST:
case COMPLEMENTED_LIST:
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
...
return template_selection == COMPLEMENTED_LIST;
default:
TTCN_error("Matching an uninitialized/unsupported template of type @IPL4asp_Types.PSK_options.");
}
return FALSE;
}

boolean PSK__options_template::is_bound() const
{
if (template_selection == UNINITIALIZED_TEMPLATE && !is_ifpresent) return FALSE;
if (template_selection != SPECIFIC_VALUE) return TRUE;
if (single_value->field_psk__identity.is_omit() || single_value->field_psk__identity.is_bound()) return TRUE;
if (single_value->field_psk__identity__hint.is_omit() || single_value->field_psk__identity__hint.is_bound()) return TRUE;
if (single_value->field_psk__key.is_omit() || single_value->field_psk__key.is_bound()) return TRUE;
return FALSE;
}

boolean PSK__options_template::is_value() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent) return FALSE;
if (!single_value->field_psk__identity.is_omit() && !single_value->field_psk__identity.is_value()) return FALSE;
if (!single_value->field_psk__identity__hint.is_omit() && !single_value->field_psk__identity__hint.is_value()) return FALSE;
if (!single_value->field_psk__key.is_omit() && !single_value->field_psk__key.is_value()) return FALSE;
return TRUE;
}

void PSK__options_template::clean_up()
{
switch (template_selection) {
case SPECIFIC_VALUE:
delete single_value;
...
PSK__options PSK__options_template::valueof() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing a valueof or send operation on a non-specific template of type @IPL4asp_Types.PSK_options.");
PSK__options ret_val;
if (single_value->field_psk__identity.is_omit()) ret_val.psk__identity() = OMIT_VALUE;
else if (single_value->field_psk__identity.is_bound()) {
ret_val.psk__identity() = single_value->field_psk__identity.valueof();
}
if (single_value->field_psk__identity__hint.is_omit()) ret_val.psk__identity__hint() = OMIT_VALUE;
else if (single_value->field_psk__identity__hint.is_bound()) {
ret_val.psk__identity__hint() = single_value->field_psk__identity__hint.valueof();
}
if (single_value->field_psk__key.is_omit()) ret_val.psk__key() = OMIT_VALUE;
else if (single_value->field_psk__key.is_bound()) {
ret_val.psk__key() = single_value->field_psk__key.valueof();
}
return ret_val;
}

void PSK__options_template::set_type(template_sel template_type, unsigned int list_length)
{
if (template_type != VALUE_LIST && template_type != COMPLEMENTED_LIST)
TTCN_error("Setting an invalid list for a template of type @IPL4asp_Types.PSK_options.");
clean_up();
set_selection(template_type);
value_list.n_values = list_length;
value_list.list_value = new PSK__options_template[list_length];
}

PSK__options_template& PSK__options_template::list_item(unsigned int list_index) const
{
if (template_selection != VALUE_LIST && template_selection != COMPLEMENTED_LIST)
TTCN_error("Accessing a list element of a non-list template of type @IPL4asp_Types.PSK_options.");
if (list_index >= value_list.n_values)
TTCN_error("Index overflow in a value list template of type @IPL4asp_Types.PSK_options.");
return value_list.list_value[list_index];
}

CHARSTRING_template& PSK__options_template::psk__identity()
{
set_specific();
return single_value->field_psk__identity;
}

const CHARSTRING_template& PSK__options_template::psk__identity() const
{
if (template_selection != SPECIFIC_VALUE)
TTCN_error("Accessing field psk_identity of a non-specific template of type @IPL4asp_Types.PSK_options.");
return single_value->field_psk__identity;
}

CHARSTRING_template& PSK__options_template::psk__identity__hint()
{
set_specific();
return single_value->field_psk__identity__hint;
}

const CHARSTRING_template& PSK__options_template::psk__identity__hint() const
{
if (template_selection != SPECIFIC_VALUE)
TTCN_error("Accessing field psk_identity_hint of a non-specific template of type @IPL4asp_Types.PSK_options.");
return single_value->field_psk__identity__hint;
}

CHARSTRING_template& PSK__options_template::psk__key()
{
set_specific();
return single_value->field_psk__key;
}

const CHARSTRING_template& PSK__options_template::psk__key() const
{
if (template_selection != SPECIFIC_VALUE)
TTCN_error("Accessing field psk_key of a non-specific template of type @IPL4asp_Types.PSK_options.");
return single_value->field_psk__key;
}

int PSK__options_template::size_of() const
{
  if (is_ifpresent) TTCN_error("Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options which has an ifpresent attribute.");
  switch (template_selection)
  {
  case SPECIFIC_VALUE:
  {    int ret_val = 0;
      if (single_value->field_psk__identity.is_present()) ret_val++;
      if (single_value->field_psk__identity__hint.is_present()) ret_val++;
      if (single_value->field_psk__key.is_present()) ret_val++;
      return ret_val;
    }
  case VALUE_LIST:
   {
     if (value_list.n_values<1)
       TTCN_error("Internal error: Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options containing an empty list.");
      int item_size = value_list.list_value[0].size_of();
      for (unsigned int l_idx = 1; l_idx < value_list.n_values; l_idx++)
      {
        if (value_list.list_value[l_idx].size_of()!=item_size)
          TTCN_error("Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options containing a value list with different sizes.");
      }
      return item_size;
    }
  case OMIT_VALUE:
    TTCN_error("Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options containing omit value.");
  case ANY_VALUE:
  case ANY_OR_OMIT:
    TTCN_error("Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options containing */? value.");
  case COMPLEMENTED_LIST:
    TTCN_error("Performing sizeof() operation on a template of type @IPL4asp_Types.PSK_options containing complemented list.");
  default:
    TTCN_error("Performing sizeof() operation on an uninitialized/unsupported template of type @IPL4asp_Types.PSK_options.");
  }
  return 0;
}

void PSK__options_template::log() const
{
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger::log_event_str("{ psk_identity := ");
single_value->field_psk__identity.log();
TTCN_Logger::log_event_str(", psk_identity_hint := ");
single_value->field_psk__identity__hint.log();
TTCN_Logger::log_event_str(", psk_key := ");
single_value->field_psk__key.log();
TTCN_Logger::log_event_str(" }");
break;
case COMPLEMENTED_LIST:
TTCN_Logger::log_event_str("complement ");
...
void PSK__options_template::log_match(const PSK__options& match_value, boolean legacy) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value, legacy)){
TTCN_Logger::print_logmatch_buffer();
...
if (template_selection == SPECIFIC_VALUE) {
size_t previous_size = TTCN_Logger::get_logmatch_buffer_len();
if (match_value.psk__identity().ispresent()){
if(!single_value->field_psk__identity.match(match_value.psk__identity(), legacy)){
TTCN_Logger::log_logmatch_info(".psk_identity");
single_value->field_psk__identity.log_match(match_value.psk__identity(), legacy);
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
} else {
if (!single_value->field_psk__identity.match_omit(legacy)){
...
if (match_value.psk__identity__hint().ispresent()){
if(!single_value->field_psk__identity__hint.match(match_value.psk__identity__hint(), legacy)){
TTCN_Logger::log_logmatch_info(".psk_identity_hint");
single_value->field_psk__identity__hint.log_match(match_value.psk__identity__hint(), legacy);
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
} else {
if (!single_value->field_psk__identity__hint.match_omit(legacy)){
...
if (match_value.psk__key().ispresent()){
if(!single_value->field_psk__key.match(match_value.psk__key(), legacy)){
TTCN_Logger::log_logmatch_info(".psk_key");
single_value->field_psk__key.log_match(match_value.psk__key(), legacy);
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
} else {
if (!single_value->field_psk__key.match_omit(legacy)){
...
if (template_selection == SPECIFIC_VALUE) {
TTCN_Logger::log_event_str("{ psk_identity := ");
if (match_value.psk__identity().ispresent()) single_value->field_psk__identity.log_match(match_value.psk__identity(), legacy);
else {
TTCN_Logger::log_event_str("omit with ");
single_value->field_psk__identity.log();
if (single_value->field_psk__identity.match_omit(legacy)) TTCN_Logger::log_event_str(" matched");
else TTCN_Logger::log_event_str(" unmatched");
}
TTCN_Logger::log_event_str(", psk_identity_hint := ");
if (match_value.psk__identity__hint().ispresent()) single_value->field_psk__identity__hint.log_match(match_value.psk__identity__hint(), legacy);
else {
TTCN_Logger::log_event_str("omit with ");
single_value->field_psk__identity__hint.log();
if (single_value->field_psk__identity__hint.match_omit(legacy)) TTCN_Logger::log_event_str(" matched");
else TTCN_Logger::log_event_str(" unmatched");
}
TTCN_Logger::log_event_str(", psk_key := ");
if (match_value.psk__key().ispresent()) single_value->field_psk__key.log_match(match_value.psk__key(), legacy);
else {
TTCN_Logger::log_event_str("omit with ");
single_value->field_psk__key.log();
if (single_value->field_psk__key.match_omit(legacy)) TTCN_Logger::log_event_str(" matched");
else TTCN_Logger::log_event_str(" unmatched");
}
TTCN_Logger::log_event_str(" }");
} else {
...
void PSK__options_template::encode_text(Text_Buf& text_buf) const
{
encode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
single_value->field_psk__identity.encode_text(text_buf);
single_value->field_psk__identity__hint.encode_text(text_buf);
single_value->field_psk__key.encode_text(text_buf);
case OMIT_VALUE:
case ANY_VALUE:
case ANY_OR_OMIT:
break;
...
break;
default:
TTCN_error("Text encoder: Encoding an uninitialized/unsupported template of type @IPL4asp_Types.PSK_options.");
}
}

void PSK__options_template::decode_text(Text_Buf& text_buf)
{
clean_up();
decode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
single_value = new single_value_struct;
single_value->field_psk__identity.decode_text(text_buf);
single_value->field_psk__identity__hint.decode_text(text_buf);
single_value->field_psk__key.decode_text(text_buf);
case OMIT_VALUE:
case ANY_VALUE:
case ANY_OR_OMIT:
break;
...
break;
default:
TTCN_error("Text decoder: An unknown/unsupported selection was received in a template of type @IPL4asp_Types.PSK_options.");
}
}

void PSK__options_template::set_param(Module_Param& param)
{
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
  ...
  case Module_Param::MP_List_Template:
  case Module_Param::MP_ComplementList_Template: {
    PSK__options_template new_temp;
    new_temp.set_type(param.get_type()==Module_Param::MP_List_Template ? VALUE_LIST : COMPLEMENTED_LIST, param.get_size());
    for (size_t p_i=0; p_i<param.get_size(); p_i++) {
      new_temp.list_item(p_i).set_param(*param.get_elem(p_i));
    }
  ...
  case Module_Param::MP_Value_List:
    if (3<param.get_size()) {
      param.error("record template of type @IPL4asp_Types.PSK_options has 3 fields but list value has %d fields", (int)param.get_size());
    }
    if (param.get_size()>0 && param.get_elem(0)->get_type()!=Module_Param::MP_NotUsed) psk__identity().set_param(*param.get_elem(0));
    if (param.get_size()>1 && param.get_elem(1)->get_type()!=Module_Param::MP_NotUsed) psk__identity__hint().set_param(*param.get_elem(1));
    if (param.get_size()>2 && param.get_elem(2)->get_type()!=Module_Param::MP_NotUsed) psk__key().set_param(*param.get_elem(2));
...
void PSK__options_template::check_restriction(template_res t_res, const char* t_name, boolean legacy) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
case TR_VALUE:
if (template_selection!=SPECIFIC_VALUE || is_ifpresent) break;
single_value->field_psk__identity.check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.PSK_options");
single_value->field_psk__identity__hint.check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.PSK_options");
single_value->field_psk__key.check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.PSK_options");
return;
case TR_PRESENT:
if (!match_omit(legacy)) return;
break;
...
TTCN_error("Restriction `%s' on template of type %s violated.", get_res_name(t_res), t_name ? t_name : "@IPL4asp_Types.PSK_options");
}

boolean PSK__options_template::is_present(boolean legacy) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit(legacy);
}

boolean PSK__options_template::match_omit(boolean legacy) const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
MTU__discover::MTU__discover()
{
enum_value = UNBOUND_VALUE;
}

MTU__discover::MTU__discover(int other_value)
{
if (!is_valid_enum(other_value)) TTCN_error("Initializing a variable of enumerated type @IPL4asp_Types.MTU_discover with invalid numeric value %d.", other_value);
enum_value = (enum_type)other_value;
}

MTU__discover::MTU__discover(enum_type other_value)
{
enum_value = other_value;
}

MTU__discover::MTU__discover(const MTU__discover& other_value)
: Base_Type()
{
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("Copying an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
enum_value = other_value.enum_value;
}

MTU__discover& MTU__discover::operator=(int other_value)
{
if (!is_valid_enum(other_value)) TTCN_error("Assigning unknown numeric value %d to a variable of enumerated type @IPL4asp_Types.MTU_discover.", other_value);
enum_value = (enum_type)other_value;
return *this;
}

MTU__discover& MTU__discover::operator=(enum_type other_value)
{
enum_value = other_value;
return *this;
}

MTU__discover& MTU__discover::operator=(const MTU__discover& other_value)
{
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("Assignment of an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
enum_value = other_value.enum_value;
return *this;
}

boolean MTU__discover::operator==(enum_type other_value) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("The left operand of comparison is an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
return enum_value == other_value;
}

boolean MTU__discover::operator==(const MTU__discover& other_value) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("The left operand of comparison is an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("The right operand of comparison is an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
...
const char *MTU__discover::enum_to_str(enum_type enum_par)
{
switch (enum_par) {
case PMTUDISC__DONT: return "PMTUDISC_DONT";
case PMTUDISC__WANT: return "PMTUDISC_WANT";
case PMTUDISC__DO: return "PMTUDISC_DO";
case MTU: return "MTU";
default: return "<unknown>";
}
}

MTU__discover::enum_type MTU__discover::str_to_enum(const char *str_par)
{
if (!strcmp(str_par, "PMTUDISC_DONT")) return PMTUDISC__DONT;
else if (!strcmp(str_par, "PMTUDISC_WANT")) return PMTUDISC__WANT;
else if (!strcmp(str_par, "PMTUDISC_DO")) return PMTUDISC__DO;
else if (!strcmp(str_par, "MTU")) return MTU;
else return UNKNOWN_VALUE;
}

boolean MTU__discover::is_valid_enum(int int_par)
{
switch (int_par) {
case 0:
case 1:
...
int MTU__discover::enum2int(enum_type enum_par)
{
if (enum_par==UNBOUND_VALUE || enum_par==UNKNOWN_VALUE) TTCN_error("The argument of function enum2int() is an %s value of enumerated type @IPL4asp_Types.MTU_discover.", enum_par==UNBOUND_VALUE?"unbound":"invalid");
return enum_par;
}

int MTU__discover::enum2int(const MTU__discover& enum_par)
{
if (enum_par.enum_value==UNBOUND_VALUE || enum_par.enum_value==UNKNOWN_VALUE) TTCN_error("The argument of function enum2int() is an %s value of enumerated type @IPL4asp_Types.MTU_discover.", enum_par==UNBOUND_VALUE?"unbound":"invalid");
return enum_par.enum_value;
}

void MTU__discover::int2enum(int int_val)
{
if (!is_valid_enum(int_val)) TTCN_error("Assigning invalid numeric value %d to a variable of enumerated type @IPL4asp_Types.MTU_discover.", int_val);
enum_value = (enum_type)int_val;
}

MTU__discover::operator MTU__discover::enum_type() const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("Using the value of an unbound variable of enumerated type @IPL4asp_Types.MTU_discover.");
return enum_value;
}

void MTU__discover::log() const
{
if (enum_value != UNBOUND_VALUE) TTCN_Logger::log_event_enum(enum_to_str(enum_value), enum_value);
else TTCN_Logger::log_event_unbound();
}

void MTU__discover::set_param(Module_Param& param)
{
  param.basic_check(Module_Param::BC_VALUE, "enumerated value");
  if (param.get_type()!=Module_Param::MP_Enumerated) param.type_error("enumerated value", "@IPL4asp_Types.MTU_discover");
...
void MTU__discover::encode_text(Text_Buf& text_buf) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("Text encoder: Encoding an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
...
if (!is_valid_enum(enum_value)) TTCN_error("Text decoder: Unknown numeric value %d was received for enumerated type @IPL4asp_Types.MTU_discover.", enum_value);
}

void MTU__discover_template::copy_template(const MTU__discover_template& other_value)
{
set_selection(other_value);
switch (template_selection) {
case SPECIFIC_VALUE:
...
case COMPLEMENTED_LIST:
value_list.n_values = other_value.value_list.n_values;
value_list.list_value = new MTU__discover_template[value_list.n_values];
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
value_list.list_value[list_count].copy_template(other_value.value_list.list_value[list_count]);
break;
default:
TTCN_error("Copying an uninitialized/unsupported template of enumerated type @IPL4asp_Types.MTU_discover.");
}
}

MTU__discover_template::MTU__discover_template()
{
}

MTU__discover_template::MTU__discover_template(template_sel other_value)
 : Base_Template(other_value)
{
check_single_selection(other_value);
}

MTU__discover_template::MTU__discover_template(int other_value)
 : Base_Template(SPECIFIC_VALUE)
{
if (!MTU__discover::is_valid_enum(other_value)) TTCN_error("Initializing a template of enumerated type @IPL4asp_Types.MTU_discover with unknown numeric value %d.", other_value);
single_value = (MTU__discover::enum_type)other_value;
}

MTU__discover_template::MTU__discover_template(MTU__discover::enum_type other_value)
 : Base_Template(SPECIFIC_VALUE)
{
single_value = other_value;
}

MTU__discover_template::MTU__discover_template(const MTU__discover& other_value)
 : Base_Template(SPECIFIC_VALUE)
{
if (other_value.enum_value == MTU__discover::UNBOUND_VALUE) TTCN_error("Creating a template from an unbound value of enumerated type @IPL4asp_Types.MTU_discover.");
single_value = other_value.enum_value;
}

MTU__discover_template::MTU__discover_template(const OPTIONAL<MTU__discover>& other_value)
{
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
set_selection(SPECIFIC_VALUE);
single_value = (MTU__discover::enum_type)(const MTU__discover&)other_value;
break;
case OPTIONAL_OMIT:
set_selection(OMIT_VALUE);
break;
default:
TTCN_error("Creating a template of enumerated type @IPL4asp_Types.MTU_discover from an unbound optional field.");
}
}

MTU__discover_template::MTU__discover_template(const MTU__discover_template& other_value)
 : Base_Template()
{
copy_template(other_value);
}
...
boolean MTU__discover_template::is_bound() const
{
if (template_selection == UNINITIALIZED_TEMPLATE && !is_ifpresent) return FALSE;
return TRUE;
}

boolean MTU__discover_template::is_value() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent) return FALSE;
return single_value != MTU__discover::UNBOUND_VALUE;
}

void MTU__discover_template::clean_up()
{
if (template_selection == VALUE_LIST || template_selection == COMPLEMENTED_LIST) delete [] value_list.list_value;
template_selection = UNINITIALIZED_TEMPLATE;
}

MTU__discover_template& MTU__discover_template::operator=(template_sel other_value)
{
check_single_selection(other_value);
clean_up();
set_selection(other_value);
...
MTU__discover_template& MTU__discover_template::operator=(int other_value)
{
if (!MTU__discover::is_valid_enum(other_value)) TTCN_warning("Assigning unknown numeric value %d to a template of enumerated type @IPL4asp_Types.MTU_discover.", other_value);
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = (MTU__discover::enum_type)other_value;
return *this;
...
MTU__discover_template& MTU__discover_template::operator=(MTU__discover::enum_type other_value)
{
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = other_value;
...
MTU__discover_template& MTU__discover_template::operator=(const MTU__discover& other_value)
{
if (other_value.enum_value == MTU__discover::UNBOUND_VALUE) TTCN_error("Assignment of an unbound value of enumerated type @IPL4asp_Types.MTU_discover to a template.");
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = other_value.enum_value;
return *this;
...
MTU__discover_template& MTU__discover_template::operator=(const OPTIONAL<MTU__discover>& other_value)
{
clean_up();
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
...
break;
default:
TTCN_error("Assignment of an unbound optional field to a template of enumerated type @IPL4asp_Types.MTU_discover.");
}
return *this;
}

MTU__discover_template& MTU__discover_template::operator=(const MTU__discover_template& other_value)
{
if (&other_value != this) {
clean_up();
copy_template(other_value);
...
boolean MTU__discover_template::match(MTU__discover::enum_type other_value, boolean) const
{
switch (template_selection) {
case SPECIFIC_VALUE:
...
return template_selection == COMPLEMENTED_LIST;
default:
TTCN_error("Matching an uninitialized/unsupported template of enumerated type @IPL4asp_Types.MTU_discover.");
}
return FALSE;
}

boolean MTU__discover_template::match(const MTU__discover& other_value, boolean) const
{
if (other_value.enum_value == MTU__discover::UNBOUND_VALUE) TTCN_error("Matching a template of enumerated type @IPL4asp_Types.MTU_discover with an unbound value.");
return match(other_value.enum_value);
}

MTU__discover::enum_type MTU__discover_template::valueof() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent) TTCN_error("Performing a valueof or send operation on a non-specific template of enumerated type @IPL4asp_Types.MTU_discover.");
return single_value;
}

void MTU__discover_template::set_type(template_sel template_type, unsigned int list_length)
{
if (template_type != VALUE_LIST && template_type != COMPLEMENTED_LIST) TTCN_error("Setting an invalid list type for a template of enumerated type @IPL4asp_Types.MTU_discover.");
clean_up();
set_selection(template_type);
value_list.n_values = list_length;
value_list.list_value = new MTU__discover_template[list_length];
}

MTU__discover_template& MTU__discover_template::list_item(unsigned int list_index)
{
if (template_selection != VALUE_LIST && template_selection != COMPLEMENTED_LIST) TTCN_error("Accessing a list element in a non-list template of enumerated type @IPL4asp_Types.MTU_discover.");
if (list_index >= value_list.n_values) TTCN_error("Index overflow in a value list template of enumerated type @IPL4asp_Types.MTU_discover.");
return value_list.list_value[list_index];
}

void MTU__discover_template::log() const
{
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger::log_event_enum(MTU__discover::enum_to_str(single_value), single_value);
break;
case COMPLEMENTED_LIST:
TTCN_Logger::log_event_str("complement ");
case VALUE_LIST:
...
void MTU__discover_template::log_match(const MTU__discover& match_value, boolean) const
{
match_value.log();
TTCN_Logger::log_event_str(" with ");
log();
...
void MTU__discover_template::encode_text(Text_Buf& text_buf) const
{
encode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
...
break;
default:
TTCN_error("Text encoder: Encoding an uninitialized/unsupported template of enumerated type @IPL4asp_Types.MTU_discover.");
}
}

void MTU__discover_template::decode_text(Text_Buf& text_buf)
{
clean_up();
decode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
single_value = (MTU__discover::enum_type)text_buf.pull_int().get_val();
if (!MTU__discover::is_valid_enum(single_value)) TTCN_error("Text decoder: Unknown numeric value %d was received for a template of enumerated type @IPL4asp_Types.MTU_discover.", single_value);
case OMIT_VALUE:
case ANY_VALUE:
case ANY_OR_OMIT:
break;
...
break;
default:
TTCN_error("Text decoder: An unknown/unsupported selection was received for a template of enumerated type @IPL4asp_Types.MTU_discover.");
}
}

boolean MTU__discover_template::is_present(boolean legacy) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit(legacy);
}

boolean MTU__discover_template::match_omit(boolean legacy) const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void MTU__discover_template::set_param(Module_Param& param)
{
  ...
  case Module_Param::MP_List_Template:
  case Module_Param::MP_ComplementList_Template: {
    MTU__discover_template new_temp;
    new_temp.set_type(m_p->get_type()==Module_Param::MP_List_Template ? VALUE_LIST : COMPLEMENTED_LIST, m_p->get_size());
    for (size_t p_i=0; p_i<m_p->get_size(); p_i++) {
      new_temp.list_item(p_i).set_param(*m_p->get_elem(p_i));
    }
  ...
  case Module_Param::MP_Enumerated: {
    MTU__discover::enum_type enum_val = MTU__discover::str_to_enum(m_p->get_enumerated());
    if (!MTU__discover::is_valid_enum(enum_val)) {
      param.error("Invalid enumerated value for type @IPL4asp_Types.MTU_discover.");
    }
    *this = enum_val;
  } break;
...
void MTU__discover_template::check_restriction(template_res t_res, const char* t_name,
...
TTCN_error("Restriction `%s' on template of type %s violated.", get_res_name(t_res), t_name ? t_name : "@IPL4asp_Types.MTU_discover");
}
...
break;
case ALT_udp__encap:
field_udp__encap = new UDP__ENCAP__Param(*other_value.field_udp__encap);
break;
case ALT_dscp:
field_dscp = new INTEGER(*other_value.field_dscp);
break;
case ALT_mtu__discover:
field_mtu__discover = new MTU__discover(*other_value.field_mtu__discover);
break;
case ALT_psk__options:
field_psk__options = new PSK__options(*other_value.field_psk__options);
break;
default:
...
case ALT_udp__encap:
return *field_udp__encap == *other_value.field_udp__encap;
case ALT_dscp:
return *field_dscp == *other_value.field_dscp;
case ALT_mtu__discover:
return *field_mtu__discover == *other_value.field_mtu__discover;
case ALT_psk__options:
return *field_psk__options == *other_value.field_psk__options;
default:
return FALSE;
}
}
...
UDP__ENCAP__Param& Option::udp__encap()
{
if (union_selection != ALT_udp__encap) {
clean_up();
field_udp__encap = new UDP__ENCAP__Param;
union_selection = ALT_udp__encap;
}
return *field_udp__encap;
}

const UDP__ENCAP__Param& Option::udp__encap() const
{
if (union_selection != ALT_udp__encap) TTCN_error("Using non-selected field udp_encap in a value of union type @IPL4asp_Types.Option.");
return *field_udp__encap;
}

INTEGER& Option::dscp()
{
if (union_selection != ALT_dscp) {
clean_up();
field_dscp = new INTEGER;
union_selection = ALT_dscp;
}
return *field_dscp;
}

const INTEGER& Option::dscp() const
{
if (union_selection != ALT_dscp) TTCN_error("Using non-selected field dscp in a value of union type @IPL4asp_Types.Option.");
return *field_dscp;
}

MTU__discover& Option::mtu__discover()
{
if (union_selection != ALT_mtu__discover) {
clean_up();
field_mtu__discover = new MTU__discover;
union_selection = ALT_mtu__discover;
}
return *field_mtu__discover;
}

const MTU__discover& Option::mtu__discover() const
{
if (union_selection != ALT_mtu__discover) TTCN_error("Using non-selected field mtu_discover in a value of union type @IPL4asp_Types.Option.");
return *field_mtu__discover;
}

PSK__options& Option::psk__options()
{
if (union_selection != ALT_psk__options) {
clean_up();
field_psk__options = new PSK__options;
union_selection = ALT_psk__options;
}
return *field_psk__options;
}

const PSK__options& Option::psk__options() const
{
if (union_selection != ALT_psk__options) TTCN_error("Using non-selected field psk_options in a value of union type @IPL4asp_Types.Option.");
return *field_psk__options;
}
...
case ALT_udp__encap: return field_udp__encap->is_value();
case ALT_dscp: return field_dscp->is_value();
case ALT_mtu__discover: return field_mtu__discover->is_value();
case ALT_psk__options: return field_psk__options->is_value();
default: TTCN_error("Invalid selection in union is_bound");}
}
...
case ALT_tls__hostname:
  ...
  break;
case ALT_udp__encap:
  delete field_udp__encap;
  break;
case ALT_dscp:
  delete field_dscp;
  break;
case ALT_mtu__discover:
  delete field_mtu__discover;
  break;
case ALT_psk__options:
  delete field_psk__options;
  break;
default:
  break;
}
...
field_mtu__discover->log();
TTCN_Logger::log_event_str(" }");
break;
case ALT_psk__options:
TTCN_Logger::log_event_str("{ psk_options := ");
field_psk__options->log();
TTCN_Logger::log_event_str(" }");
break;
default:
TTCN_Logger::log_event_unbound();
...
void Option::set_param(Module_Param& param)
{
  ...
  if (!strcmp(mp_last->get_id()->get_name(), "udp_encap")) {
    udp__encap().set_param(*mp_last);
    if (!udp__encap().is_bound()) clean_up();
    return;
  }
  if (!strcmp(mp_last->get_id()->get_name(), "dscp")) {
    dscp().set_param(*mp_last);
    if (!dscp().is_bound()) clean_up();
    return;
  }
  if (!strcmp(mp_last->get_id()->get_name(), "mtu_discover")) {
    mtu__discover().set_param(*mp_last);
    if (!mtu__discover().is_bound()) clean_up();
    return;
  }
  if (!strcmp(mp_last->get_id()->get_name(), "psk_options")) {
    psk__options().set_param(*mp_last);
    if (!psk__options().is_bound()) clean_up();
    return;
  }
...
case ALT_udp__encap:
field_udp__encap->set_implicit_omit(); break;
case ALT_dscp:
field_dscp->set_implicit_omit(); break;
case ALT_mtu__discover:
field_mtu__discover->set_implicit_omit(); break;
case ALT_psk__options:
field_psk__options->set_implicit_omit(); break;
default: break;
}
}
...
break;
case ALT_udp__encap:
field_udp__encap->encode_text(text_buf);
break;
case ALT_dscp:
field_dscp->encode_text(text_buf);
break;
case ALT_mtu__discover:
field_mtu__discover->encode_text(text_buf);
break;
case ALT_psk__options:
field_psk__options->encode_text(text_buf);
break;
default:
...
break;
case ALT_udp__encap:
udp__encap().decode_text(text_buf);
break;
case ALT_dscp:
dscp().decode_text(text_buf);
break;
case ALT_mtu__discover:
mtu__discover().decode_text(text_buf);
break;
case ALT_psk__options:
psk__options().decode_text(text_buf);
break;
default:
...
break;
case Option::ALT_udp__encap:
single_value.field_udp__encap = new UDP__ENCAP__Param_template(other_value.udp__encap());
break;
case Option::ALT_dscp:
single_value.field_dscp = new INTEGER_template(other_value.dscp());
break;
case Option::ALT_mtu__discover:
single_value.field_mtu__discover = new MTU__discover_template(other_value.mtu__discover());
break;
case Option::ALT_psk__options:
single_value.field_psk__options = new PSK__options_template(other_value.psk__options());
break;
default:
...
break;
case Option::ALT_udp__encap:
single_value.field_udp__encap = new UDP__ENCAP__Param_template(*other_value.single_value.field_udp__encap);
break;
case Option::ALT_dscp:
single_value.field_dscp = new INTEGER_template(*other_value.single_value.field_dscp);
break;
case Option::ALT_mtu__discover:
single_value.field_mtu__discover = new MTU__discover_template(*other_value.single_value.field_mtu__discover);
break;
case Option::ALT_psk__options:
single_value.field_psk__options = new PSK__options_template(*other_value.single_value.field_psk__options);
break;
default:
...
break;
case Option::ALT_udp__encap:
delete single_value.field_udp__encap;
break;
case Option::ALT_dscp:
delete single_value.field_dscp;
break;
case Option::ALT_mtu__discover:
delete single_value.field_mtu__discover;
break;
case Option::ALT_psk__options:
delete single_value.field_psk__options;
default:
break;
}
break;
...
case Option::ALT_udp__encap:
return single_value.field_udp__encap->match(other_value.udp__encap(), legacy);
case Option::ALT_dscp:
return single_value.field_dscp->match(other_value.dscp(), legacy);
case Option::ALT_mtu__discover:
return single_value.field_mtu__discover->match(other_value.mtu__discover(), legacy);
case Option::ALT_psk__options:
return single_value.field_psk__options->match(other_value.psk__options(), legacy);
default:
...
case Option::ALT_udp__encap:
return single_value.field_udp__encap->is_value();
case Option::ALT_dscp:
return single_value.field_dscp->is_value();
case Option::ALT_mtu__discover:
return single_value.field_mtu__discover->is_value();
case Option::ALT_psk__options:
return single_value.field_psk__options->is_value();
default:
...
break;
case Option::ALT_udp__encap:
ret_val.udp__encap() = single_value.field_udp__encap->valueof();
break;
case Option::ALT_dscp:
ret_val.dscp() = single_value.field_dscp->valueof();
break;
case Option::ALT_mtu__discover:
ret_val.mtu__discover() = single_value.field_mtu__discover->valueof();
break;
case Option::ALT_psk__options:
ret_val.psk__options() = single_value.field_psk__options->valueof();
break;
default:
...
UDP__ENCAP__Param_template& Option_template::udp__encap()
{
if (template_selection != SPECIFIC_VALUE || single_value.union_selection != Option::ALT_udp__encap) {
template_sel old_selection = template_selection;
clean_up();
if (old_selection == ANY_VALUE || old_selection == ANY_OR_OMIT) single_value.field_udp__encap = new UDP__ENCAP__Param_template(ANY_VALUE);
else single_value.field_udp__encap = new UDP__ENCAP__Param_template;
single_value.union_selection = Option::ALT_udp__encap;
set_selection(SPECIFIC_VALUE);
}
return *single_value.field_udp__encap;
}

const UDP__ENCAP__Param_template& Option_template::udp__encap() const
{
if (template_selection != SPECIFIC_VALUE) TTCN_error("Accessing field udp_encap in a non-specific template of union type @IPL4asp_Types.Option.");
if (single_value.union_selection != Option::ALT_udp__encap) TTCN_error("Accessing non-selected field udp_encap in a template of union type @IPL4asp_Types.Option.");
return *single_value.field_udp__encap;
}

INTEGER_template& Option_template::dscp()
{
if (template_selection != SPECIFIC_VALUE || single_value.union_selection != Option::ALT_dscp) {
template_sel old_selection = template_selection;
clean_up();
if (old_selection == ANY_VALUE || old_selection == ANY_OR_OMIT) single_value.field_dscp = new INTEGER_template(ANY_VALUE);
else single_value.field_dscp = new INTEGER_template;
single_value.union_selection = Option::ALT_dscp;
set_selection(SPECIFIC_VALUE);
}
return *single_value.field_dscp;
}

const INTEGER_template& Option_template::dscp() const
{
if (template_selection != SPECIFIC_VALUE) TTCN_error("Accessing field dscp in a non-specific template of union type @IPL4asp_Types.Option.");
if (single_value.union_selection != Option::ALT_dscp) TTCN_error("Accessing non-selected field dscp in a template of union type @IPL4asp_Types.Option.");
return *single_value.field_dscp;
}

MTU__discover_template& Option_template::mtu__discover()
{
if (template_selection != SPECIFIC_VALUE || single_value.union_selection != Option::ALT_mtu__discover) {
template_sel old_selection = template_selection;
clean_up();
if (old_selection == ANY_VALUE || old_selection == ANY_OR_OMIT) single_value.field_mtu__discover = new MTU__discover_template(ANY_VALUE);
else single_value.field_mtu__discover = new MTU__discover_template;
single_value.union_selection = Option::ALT_mtu__discover;
set_selection(SPECIFIC_VALUE);
}
return *single_value.field_mtu__discover;
}

const MTU__discover_template& Option_template::mtu__discover() const
{
if (template_selection != SPECIFIC_VALUE) TTCN_error("Accessing field mtu_discover in a non-specific template of union type @IPL4asp_Types.Option.");
if (single_value.union_selection != Option::ALT_mtu__discover) TTCN_error("Accessing non-selected field mtu_discover in a template of union type @IPL4asp_Types.Option.");
return *single_value.field_mtu__discover;
}

PSK__options_template& Option_template::psk__options()
{
if (template_selection != SPECIFIC_VALUE || single_value.union_selection != Option::ALT_psk__options) {
template_sel old_selection = template_selection;
clean_up();
if (old_selection == ANY_VALUE || old_selection == ANY_OR_OMIT) single_value.field_psk__options = new PSK__options_template(ANY_VALUE);
else single_value.field_psk__options = new PSK__options_template;
single_value.union_selection = Option::ALT_psk__options;
set_selection(SPECIFIC_VALUE);
}
return *single_value.field_psk__options;
}

const PSK__options_template& Option_template::psk__options() const
{
if (template_selection != SPECIFIC_VALUE) TTCN_error("Accessing field psk_options in a non-specific template of union type @IPL4asp_Types.Option.");
if (single_value.union_selection != Option::ALT_psk__options) TTCN_error("Accessing non-selected field psk_options in a template of union type @IPL4asp_Types.Option.");
return *single_value.field_psk__options;
}
...
case Option::ALT_udp__encap:
TTCN_Logger::log_event_str("{ udp_encap := ");
single_value.field_udp__encap->log();
TTCN_Logger::log_event_str(" }");
break;
case Option::ALT_dscp:
TTCN_Logger::log_event_str("{ dscp := ");
single_value.field_dscp->log();
TTCN_Logger::log_event_str(" }");
break;
case Option::ALT_mtu__discover:
TTCN_Logger::log_event_str("{ mtu_discover := ");
single_value.field_mtu__discover->log();
TTCN_Logger::log_event_str(" }");
break;
case Option::ALT_psk__options:
TTCN_Logger::log_event_str("{ psk_options := ");
single_value.field_psk__options->log();
TTCN_Logger::log_event_str(" }");
break;
default:
TTCN_Logger::log_event_str("<invalid selector>");
...
single_value.field_udp__encap->log_match(match_value.udp__encap(), legacy);
} else {
TTCN_Logger::log_event_str("{ udp_encap := ");
single_value.field_udp__encap->log_match(match_value.udp__encap(), legacy);
TTCN_Logger::log_event_str(" }");
...
single_value.field_dscp->log_match(match_value.dscp(), legacy);
} else {
TTCN_Logger::log_event_str("{ dscp := ");
single_value.field_dscp->log_match(match_value.dscp(), legacy);
TTCN_Logger::log_event_str(" }");
...
single_value.field_mtu__discover->log_match(match_value.mtu__discover(), legacy);
} else {
TTCN_Logger::log_event_str("{ mtu_discover := ");
single_value.field_mtu__discover->log_match(match_value.mtu__discover(), legacy);
TTCN_Logger::log_event_str(" }");
...
single_value.field_psk__options->log_match(match_value.psk__options(), legacy);
} else {
TTCN_Logger::log_event_str("{ psk_options := ");
single_value.field_psk__options->log_match(match_value.psk__options(), legacy);
TTCN_Logger::log_event_str(" }");
...
break;
case Option::ALT_udp__encap:
single_value.field_udp__encap->encode_text(text_buf);
break;
case Option::ALT_dscp:
single_value.field_dscp->encode_text(text_buf);
break;
case Option::ALT_mtu__discover:
single_value.field_mtu__discover->encode_text(text_buf);
break;
case Option::ALT_psk__options:
single_value.field_psk__options->encode_text(text_buf);
break;
default:
...
break;
case Option::ALT_udp__encap:
single_value.field_udp__encap = new UDP__ENCAP__Param_template;
single_value.field_udp__encap->decode_text(text_buf);
break;
case Option::ALT_dscp:
single_value.field_dscp = new INTEGER_template;
single_value.field_dscp->decode_text(text_buf);
break;
case Option::ALT_mtu__discover:
single_value.field_mtu__discover = new MTU__discover_template;
single_value.field_mtu__discover->decode_text(text_buf);
break;
case Option::ALT_psk__options:
single_value.field_psk__options = new PSK__options_template;
single_value.field_psk__options->decode_text(text_buf);
break;
default:
...
void Option_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (strcmp("reuseAddress", param_field) == 0) {
      ...
      return;
    } else if (strcmp("udp_encap", param_field) == 0) {
      udp__encap().set_param(param);
      return;
    } else if (strcmp("dscp", param_field) == 0) {
      dscp().set_param(param);
      return;
    } else if (strcmp("mtu_discover", param_field) == 0) {
      mtu__discover().set_param(param);
      return;
    } else if (strcmp("psk_options", param_field) == 0) {
      psk__options().set_param(param);
      return;
...
return;
case Option::ALT_udp__encap:
single_value.field_udp__encap->check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.Option");
return;
case Option::ALT_dscp:
single_value.field_dscp->check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.Option");
return;
case Option::ALT_mtu__discover:
single_value.field_mtu__discover->check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.Option");
return;
case Option::ALT_psk__options:
single_value.field_psk__options->check_restriction(t_res, t_name ? t_name : "@IPL4asp_Types.Option");
return;
default:
...
UDP__ENCAP__Param::UDP__ENCAP__Param()
{
enum_value = UNBOUND_VALUE;
}

UDP__ENCAP__Param::UDP__ENCAP__Param(int other_value)
{
if (!is_valid_enum(other_value)) TTCN_error("Initializing a variable of enumerated type @IPL4asp_Types.UDP_ENCAP_Param with invalid numeric value %d.", other_value);
enum_value = (enum_type)other_value;
}

UDP__ENCAP__Param::UDP__ENCAP__Param(enum_type other_value)
{
enum_value = other_value;
}

UDP__ENCAP__Param::UDP__ENCAP__Param(const UDP__ENCAP__Param& other_value)
: Base_Type()
{
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("Copying an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
enum_value = other_value.enum_value;
}

UDP__ENCAP__Param& UDP__ENCAP__Param::operator=(int other_value)
{
if (!is_valid_enum(other_value)) TTCN_error("Assigning unknown numeric value %d to a variable of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", other_value);
enum_value = (enum_type)other_value;
return *this;
}

UDP__ENCAP__Param& UDP__ENCAP__Param::operator=(enum_type other_value)
{
enum_value = other_value;
return *this;
}

UDP__ENCAP__Param& UDP__ENCAP__Param::operator=(const UDP__ENCAP__Param& other_value)
{
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("Assignment of an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
enum_value = other_value.enum_value;
return *this;
}

boolean UDP__ENCAP__Param::operator==(enum_type other_value) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("The left operand of comparison is an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
return enum_value == other_value;
}

boolean UDP__ENCAP__Param::operator==(const UDP__ENCAP__Param& other_value) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("The left operand of comparison is an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
if (other_value.enum_value == UNBOUND_VALUE) TTCN_error("The right operand of comparison is an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
return enum_value == other_value.enum_value;
}
...
const char *UDP__ENCAP__Param::enum_to_str(enum_type enum_par)
{
switch (enum_par) {
case UDP__ENCAP__ESPINUDP__NON__IKE: return "UDP_ENCAP_ESPINUDP_NON_IKE";
case UDP__ENCAP__ESPINUDP: return "UDP_ENCAP_ESPINUDP";
case UDP__ENCAP__L2TPINUDP: return "UDP_ENCAP_L2TPINUDP";
default: return "<unknown>";
}
}

UDP__ENCAP__Param::enum_type UDP__ENCAP__Param::str_to_enum(const char *str_par)
{
if (!strcmp(str_par, "UDP_ENCAP_ESPINUDP_NON_IKE")) return UDP__ENCAP__ESPINUDP__NON__IKE;
else if (!strcmp(str_par, "UDP_ENCAP_ESPINUDP")) return UDP__ENCAP__ESPINUDP;
else if (!strcmp(str_par, "UDP_ENCAP_L2TPINUDP")) return UDP__ENCAP__L2TPINUDP;
else return UNKNOWN_VALUE;
}

boolean UDP__ENCAP__Param::is_valid_enum(int int_par)
{
switch (int_par) {
case 1:
case 2:
...
int UDP__ENCAP__Param::enum2int(enum_type enum_par)
{
if (enum_par==UNBOUND_VALUE || enum_par==UNKNOWN_VALUE) TTCN_error("The argument of function enum2int() is an %s value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", enum_par==UNBOUND_VALUE?"unbound":"invalid");
return enum_par;
}

int UDP__ENCAP__Param::enum2int(const UDP__ENCAP__Param& enum_par)
{
if (enum_par.enum_value==UNBOUND_VALUE || enum_par.enum_value==UNKNOWN_VALUE) TTCN_error("The argument of function enum2int() is an %s value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", enum_par==UNBOUND_VALUE?"unbound":"invalid");
return enum_par.enum_value;
}

void UDP__ENCAP__Param::int2enum(int int_val)
{
if (!is_valid_enum(int_val)) TTCN_error("Assigning invalid numeric value %d to a variable of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", int_val);
enum_value = (enum_type)int_val;
}

UDP__ENCAP__Param::operator UDP__ENCAP__Param::enum_type() const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("Using the value of an unbound variable of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
return enum_value;
}

void UDP__ENCAP__Param::log() const
{
if (enum_value != UNBOUND_VALUE) TTCN_Logger::log_event_enum(enum_to_str(enum_value), enum_value);
else TTCN_Logger::log_event_unbound();
}

void UDP__ENCAP__Param::set_param(Module_Param& param)
{
  param.basic_check(Module_Param::BC_VALUE, "enumerated value");
  if (param.get_type()!=Module_Param::MP_Enumerated) param.type_error("enumerated value", "@IPL4asp_Types.UDP_ENCAP_Param");
  enum_value = str_to_enum(param.get_enumerated());
  if (!is_valid_enum(enum_value)) {
...
void UDP__ENCAP__Param::encode_text(Text_Buf& text_buf) const
{
if (enum_value == UNBOUND_VALUE) TTCN_error("Text encoder: Encoding an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
text_buf.push_int(enum_value);
}

void UDP__ENCAP__Param::decode_text(Text_Buf& text_buf)
{
enum_value = (enum_type)text_buf.pull_int().get_val();
if (!is_valid_enum(enum_value)) TTCN_error("Text decoder: Unknown numeric value %d was received for enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", enum_value);
}

void UDP__ENCAP__Param_template::copy_template(const UDP__ENCAP__Param_template& other_value)
{
set_selection(other_value);
switch (template_selection) {
case SPECIFIC_VALUE:
...
case COMPLEMENTED_LIST:
value_list.n_values = other_value.value_list.n_values;
value_list.list_value = new UDP__ENCAP__Param_template[value_list.n_values];
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
value_list.list_value[list_count].copy_template(other_value.value_list.list_value[list_count]);
break;
default:
TTCN_error("Copying an uninitialized/unsupported template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
}
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template()
{
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(template_sel other_value)
 : Base_Template(other_value)
{
check_single_selection(other_value);
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(int other_value)
 : Base_Template(SPECIFIC_VALUE)
{
if (!UDP__ENCAP__Param::is_valid_enum(other_value)) TTCN_error("Initializing a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param with unknown numeric value %d.", other_value);
single_value = (UDP__ENCAP__Param::enum_type)other_value;
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(UDP__ENCAP__Param::enum_type other_value)
 : Base_Template(SPECIFIC_VALUE)
{
single_value = other_value;
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(const UDP__ENCAP__Param& other_value)
 : Base_Template(SPECIFIC_VALUE)
{
if (other_value.enum_value == UDP__ENCAP__Param::UNBOUND_VALUE) TTCN_error("Creating a template from an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
single_value = other_value.enum_value;
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(const OPTIONAL<UDP__ENCAP__Param>& other_value)
{
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
set_selection(SPECIFIC_VALUE);
single_value = (UDP__ENCAP__Param::enum_type)(const UDP__ENCAP__Param&)other_value;
break;
case OPTIONAL_OMIT:
set_selection(OMIT_VALUE);
break;
default:
TTCN_error("Creating a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param from an unbound optional field.");
}
}

UDP__ENCAP__Param_template::UDP__ENCAP__Param_template(const UDP__ENCAP__Param_template& other_value)
 : Base_Template()
{
copy_template(other_value);
}
...
boolean UDP__ENCAP__Param_template::is_bound() const
{
if (template_selection == UNINITIALIZED_TEMPLATE && !is_ifpresent) return FALSE;
return TRUE;
}

boolean UDP__ENCAP__Param_template::is_value() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent) return FALSE;
return single_value != UDP__ENCAP__Param::UNBOUND_VALUE;
}

void UDP__ENCAP__Param_template::clean_up()
{
if (template_selection == VALUE_LIST || template_selection == COMPLEMENTED_LIST) delete [] value_list.list_value;
template_selection = UNINITIALIZED_TEMPLATE;
}

UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(template_sel other_value)
{
check_single_selection(other_value);
clean_up();
set_selection(other_value);
...
UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(int other_value)
{
if (!UDP__ENCAP__Param::is_valid_enum(other_value)) TTCN_warning("Assigning unknown numeric value %d to a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", other_value);
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = (UDP__ENCAP__Param::enum_type)other_value;
return *this;
...
UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(UDP__ENCAP__Param::enum_type other_value)
{
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = other_value;
...
UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(const UDP__ENCAP__Param& other_value)
{
if (other_value.enum_value == UDP__ENCAP__Param::UNBOUND_VALUE) TTCN_error("Assignment of an unbound value of enumerated type @IPL4asp_Types.UDP_ENCAP_Param to a template.");
clean_up();
set_selection(SPECIFIC_VALUE);
single_value = other_value.enum_value;
return *this;
...
UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(const OPTIONAL<UDP__ENCAP__Param>& other_value)
{
clean_up();
switch (other_value.get_selection()) {
case OPTIONAL_PRESENT:
...
break;
default:
TTCN_error("Assignment of an unbound optional field to a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
}
return *this;
}

UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::operator=(const UDP__ENCAP__Param_template& other_value)
{
if (&other_value != this) {
clean_up();
copy_template(other_value);
...
boolean UDP__ENCAP__Param_template::match(UDP__ENCAP__Param::enum_type other_value, boolean) const
{
switch (template_selection) {
case SPECIFIC_VALUE:
return single_value == other_value;
...
return template_selection == COMPLEMENTED_LIST;
default:
TTCN_error("Matching an uninitialized/unsupported template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
}
return FALSE;
}

boolean UDP__ENCAP__Param_template::match(const UDP__ENCAP__Param& other_value, boolean) const
{
if (other_value.enum_value == UDP__ENCAP__Param::UNBOUND_VALUE) TTCN_error("Matching a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param with an unbound value.");
return match(other_value.enum_value);
}

UDP__ENCAP__Param::enum_type UDP__ENCAP__Param_template::valueof() const
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent) TTCN_error("Performing a valueof or send operation on a non-specific template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
return single_value;
}

void UDP__ENCAP__Param_template::set_type(template_sel template_type, unsigned int list_length)
{
if (template_type != VALUE_LIST && template_type != COMPLEMENTED_LIST) TTCN_error("Setting an invalid list type for a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
clean_up();
set_selection(template_type);
value_list.n_values = list_length;
value_list.list_value = new UDP__ENCAP__Param_template[list_length];
}

UDP__ENCAP__Param_template& UDP__ENCAP__Param_template::list_item(unsigned int list_index)
{
if (template_selection != VALUE_LIST && template_selection != COMPLEMENTED_LIST) TTCN_error("Accessing a list element in a non-list template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
if (list_index >= value_list.n_values) TTCN_error("Index overflow in a value list template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
return value_list.list_value[list_index];
}

void UDP__ENCAP__Param_template::log() const
{
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger::log_event_enum(UDP__ENCAP__Param::enum_to_str(single_value), single_value);
break;
case COMPLEMENTED_LIST:
TTCN_Logger::log_event_str("complement ");
case VALUE_LIST:
...
void UDP__ENCAP__Param_template::log_match(const UDP__ENCAP__Param& match_value, boolean) const
{
match_value.log();
TTCN_Logger::log_event_str(" with ");
log();
...
void UDP__ENCAP__Param_template::encode_text(Text_Buf& text_buf) const
{
encode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
...
break;
default:
TTCN_error("Text encoder: Encoding an uninitialized/unsupported template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
}
}

void UDP__ENCAP__Param_template::decode_text(Text_Buf& text_buf)
{
clean_up();
decode_text_base(text_buf);
switch (template_selection) {
case SPECIFIC_VALUE:
single_value = (UDP__ENCAP__Param::enum_type)text_buf.pull_int().get_val();
if (!UDP__ENCAP__Param::is_valid_enum(single_value)) TTCN_error("Text decoder: Unknown numeric value %d was received for a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", single_value);
case OMIT_VALUE:
case ANY_VALUE:
case ANY_OR_OMIT:
break;
...
break;
default:
TTCN_error("Text decoder: An unknown/unsupported selection was received for a template of enumerated type @IPL4asp_Types.UDP_ENCAP_Param.");
}
}

boolean UDP__ENCAP__Param_template::is_present(boolean legacy) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit(legacy);
}

boolean UDP__ENCAP__Param_template::match_omit(boolean legacy) const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void UDP__ENCAP__Param_template::set_param(Module_Param& param)
{
  param.basic_check(Module_Param::BC_TEMPLATE, "enumerated template");
  Module_Param_Ptr m_p = &param;
  switch (m_p->get_type()) {
  ...
  case Module_Param::MP_List_Template:
  case Module_Param::MP_ComplementList_Template: {
    UDP__ENCAP__Param_template new_temp;
    new_temp.set_type(m_p->get_type()==Module_Param::MP_List_Template ? VALUE_LIST : COMPLEMENTED_LIST, m_p->get_size());
    for (size_t p_i=0; p_i<m_p->get_size(); p_i++) {
      new_temp.list_item(p_i).set_param(*m_p->get_elem(p_i));
    }
    *this = new_temp;
    break; }
  case Module_Param::MP_Enumerated: {
    UDP__ENCAP__Param::enum_type enum_val = UDP__ENCAP__Param::str_to_enum(m_p->get_enumerated());
    if (!UDP__ENCAP__Param::is_valid_enum(enum_val)) {
      param.error("Invalid enumerated value for type @IPL4asp_Types.UDP_ENCAP_Param.");
    }
    *this = enum_val;
  } break;
...
void UDP__ENCAP__Param_template::check_restriction(template_res t_res, const char* t_name,
boolean legacy) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
...
TTCN_error("Restriction `%s' on template of type %s violated.", get_res_name(t_res), t_name ? t_name : "@IPL4asp_Types.UDP_ENCAP_Param");
}
...
void ASP__ConnId__ReadyToRelease::set_param(Module_Param& param)
{
  ...
  case Module_Param::MP_Assignment_List: {
    ...
    for (size_t val_idx=0; val_idx<param.get_size(); val_idx++) if (!value_used[val_idx]) {
      param.get_elem(val_idx)->error("Non existent field name in type @IPL4asp_Types.ASP_ConnId_ReadyToRelease: %s", param.get_elem(val_idx)->get_id()->get_name());
      break;
    }
  } break;
  default:
...
else if (!strcmp(str_par, "IPv4")) return IPv4;
