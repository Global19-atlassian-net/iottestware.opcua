...
class PSK__options;
class PSK__options_template;
class MTU__discover;
class MTU__discover_template;
class Option;
...
class UDP__ENCAP__Param;
class UDP__ENCAP__Param_template;
class OptionList;
...
class ASP__ConnId__ReadyToRelease;
class ASP__ConnId__ReadyToRelease_template;
class IPL4__Param;
...
class PSK__options {
  OPTIONAL<CHARSTRING> field_psk__identity;
  OPTIONAL<CHARSTRING> field_psk__identity__hint;
  OPTIONAL<CHARSTRING> field_psk__key;
public:
  PSK__options();
  PSK__options(const OPTIONAL<CHARSTRING>& par_psk__identity,
    const OPTIONAL<CHARSTRING>& par_psk__identity__hint,
    const OPTIONAL<CHARSTRING>& par_psk__key);
  PSK__options(const PSK__options& other_value);
  inline boolean is_component() { return FALSE; }
  void clean_up();
  PSK__options& operator=(const PSK__options& other_value);
  boolean operator==(const PSK__options& other_value) const;
  inline boolean operator!=(const PSK__options& other_value) const
    { return !(*this == other_value); }
...
inline boolean is_present() const { return is_bound(); }
  ...
  inline OPTIONAL<CHARSTRING>& psk__identity()
    {return field_psk__identity;}
  inline const OPTIONAL<CHARSTRING>& psk__identity() const
    {return field_psk__identity;}
  inline OPTIONAL<CHARSTRING>& psk__identity__hint()
    {return field_psk__identity__hint;}
  inline const OPTIONAL<CHARSTRING>& psk__identity__hint() const
    {return field_psk__identity__hint;}
  inline OPTIONAL<CHARSTRING>& psk__key()
    {return field_psk__key;}
  inline const OPTIONAL<CHARSTRING>& psk__key() const
    {return field_psk__key;}
  int size_of() const;
  void log() const;
  void set_param(Module_Param& param);
...
class PSK__options_template : public Base_Template {
struct single_value_struct;
union {
single_value_struct *single_value;
struct {
unsigned int n_values;
PSK__options_template *list_value;
} value_list;
};

void set_specific();
void copy_value(const PSK__options& other_value);
void copy_template(const PSK__options_template& other_value);

public:
PSK__options_template();
PSK__options_template(template_sel other_value);
PSK__options_template(const PSK__options& other_value);
PSK__options_template(const OPTIONAL<PSK__options>& other_value);
PSK__options_template(const PSK__options_template& other_value);
~PSK__options_template();
PSK__options_template& operator=(template_sel other_value);
PSK__options_template& operator=(const PSK__options& other_value);
PSK__options_template& operator=(const OPTIONAL<PSK__options>& other_value);
PSK__options_template& operator=(const PSK__options_template& other_value);
boolean match(const PSK__options& other_value, boolean legacy = FALSE) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
PSK__options valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
PSK__options_template& list_item(unsigned int list_index) const;
CHARSTRING_template& psk__identity();
const CHARSTRING_template& psk__identity() const;
CHARSTRING_template& psk__identity__hint();
const CHARSTRING_template& psk__identity__hint() const;
CHARSTRING_template& psk__key();
const CHARSTRING_template& psk__key() const;
int size_of() const;
void log() const;
void log_match(const PSK__options& match_value, boolean legacy = FALSE) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL, boolean legacy = FALSE) const;
...
class MTU__discover : public Base_Type { // enum
friend class MTU__discover_template;
public:
enum enum_type { PMTUDISC__DONT = 0, PMTUDISC__WANT = 1, PMTUDISC__DO = 2, MTU = 3, UNKNOWN_VALUE = 4, UNBOUND_VALUE = 5 };
private:
enum_type enum_value;

public:
MTU__discover();
MTU__discover(int other_value);
MTU__discover(enum_type other_value);
MTU__discover(const MTU__discover& other_value);

MTU__discover& operator=(int other_value);
MTU__discover& operator=(enum_type other_value);
MTU__discover& operator=(const MTU__discover& other_value);

boolean operator==(enum_type other_value) const;
boolean operator==(const MTU__discover& other_value) const;
inline boolean operator!=(enum_type other_value) const { return !(*this == other_value); }
inline boolean operator!=(const MTU__discover& other_value) const { return !(*this == other_value); }
boolean operator<(enum_type other_value) const;
boolean operator<(const MTU__discover& other_value) const;
boolean operator>(enum_type other_value) const;
boolean operator>(const MTU__discover& other_value) const;
...
static int enum2int(const MTU__discover& enum_par);
...
class MTU__discover_template : public Base_Template {
union {
MTU__discover::enum_type single_value;
struct {
unsigned int n_values;
MTU__discover_template *list_value;
} value_list;
};

void copy_template(const MTU__discover_template& other_value);

public:
MTU__discover_template();
MTU__discover_template(template_sel other_value);
MTU__discover_template(int other_value);
MTU__discover_template(MTU__discover::enum_type other_value);
MTU__discover_template(const MTU__discover& other_value);
MTU__discover_template(const OPTIONAL<MTU__discover>& other_value);
MTU__discover_template(const MTU__discover_template& other_value);
~MTU__discover_template();

boolean is_bound() const;
boolean is_value() const;
void clean_up();
MTU__discover_template& operator=(template_sel other_value);
MTU__discover_template& operator=(int other_value);
MTU__discover_template& operator=(MTU__discover::enum_type other_value);
MTU__discover_template& operator=(const MTU__discover& other_value);
MTU__discover_template& operator=(const OPTIONAL<MTU__discover>& other_value);
MTU__discover_template& operator=(const MTU__discover_template& other_value);

boolean match(MTU__discover::enum_type other_value, boolean legacy = FALSE) const;
boolean match(const MTU__discover& other_value, boolean legacy = FALSE) const;
MTU__discover::enum_type valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
MTU__discover_template& list_item(unsigned int list_index);
void log() const;
void log_match(const MTU__discover& match_value, boolean legacy = FALSE) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present(boolean legacy = FALSE) const;
boolean match_omit(boolean legacy = FALSE) const;
...
UDP__ENCAP__Param *field_udp__encap;
INTEGER *field_dscp;
MTU__discover *field_mtu__discover;
PSK__options *field_psk__options;
};
...
UDP__ENCAP__Param& udp__encap();
const UDP__ENCAP__Param& udp__encap() const;
INTEGER& dscp();
const INTEGER& dscp() const;
MTU__discover& mtu__discover();
const MTU__discover& mtu__discover() const;
PSK__options& psk__options();
const PSK__options& psk__options() const;
inline union_selection_type get_selection() const { return union_selection; }
boolean ischosen(union_selection_type checked_selection) const;
boolean is_bound() const;
boolean is_value() const;
...
UDP__ENCAP__Param_template *field_udp__encap;
INTEGER_template *field_dscp;
MTU__discover_template *field_mtu__discover;
PSK__options_template *field_psk__options;
};
} single_value;
struct {
unsigned int n_values;
...
UDP__ENCAP__Param_template& udp__encap();
const UDP__ENCAP__Param_template& udp__encap() const;
INTEGER_template& dscp();
const INTEGER_template& dscp() const;
MTU__discover_template& mtu__discover();
const MTU__discover_template& mtu__discover() const;
PSK__options_template& psk__options();
const PSK__options_template& psk__options() const;
...
class UDP__ENCAP__Param : public Base_Type { // enum
friend class UDP__ENCAP__Param_template;
public:
enum enum_type { UDP__ENCAP__ESPINUDP__NON__IKE = 1, UDP__ENCAP__ESPINUDP = 2, UDP__ENCAP__L2TPINUDP = 3, UNKNOWN_VALUE = 0, UNBOUND_VALUE = 4 };
private:
enum_type enum_value;

public:
UDP__ENCAP__Param();
UDP__ENCAP__Param(int other_value);
UDP__ENCAP__Param(enum_type other_value);
UDP__ENCAP__Param(const UDP__ENCAP__Param& other_value);

UDP__ENCAP__Param& operator=(int other_value);
UDP__ENCAP__Param& operator=(enum_type other_value);
UDP__ENCAP__Param& operator=(const UDP__ENCAP__Param& other_value);

boolean operator==(enum_type other_value) const;
boolean operator==(const UDP__ENCAP__Param& other_value) const;
inline boolean operator!=(enum_type other_value) const { return !(*this == other_value); }
inline boolean operator!=(const UDP__ENCAP__Param& other_value) const { return !(*this == other_value); }
boolean operator<(enum_type other_value) const;
boolean operator<(const UDP__ENCAP__Param& other_value) const;
boolean operator>(enum_type other_value) const;
boolean operator>(const UDP__ENCAP__Param& other_value) const;
...
static int enum2int(enum_type enum_par);
static int enum2int(const UDP__ENCAP__Param& enum_par);
int as_int() const { return enum2int(enum_value); }
void from_int(int p_val) { *this = p_val; }
void int2enum(int int_val);
operator enum_type() const;
...
class UDP__ENCAP__Param_template : public Base_Template {
union {
UDP__ENCAP__Param::enum_type single_value;
struct {
unsigned int n_values;
UDP__ENCAP__Param_template *list_value;
} value_list;
};

void copy_template(const UDP__ENCAP__Param_template& other_value);

public:
UDP__ENCAP__Param_template();
UDP__ENCAP__Param_template(template_sel other_value);
UDP__ENCAP__Param_template(int other_value);
UDP__ENCAP__Param_template(UDP__ENCAP__Param::enum_type other_value);
UDP__ENCAP__Param_template(const UDP__ENCAP__Param& other_value);
UDP__ENCAP__Param_template(const OPTIONAL<UDP__ENCAP__Param>& other_value);
UDP__ENCAP__Param_template(const UDP__ENCAP__Param_template& other_value);
~UDP__ENCAP__Param_template();

boolean is_bound() const;
boolean is_value() const;
void clean_up();
UDP__ENCAP__Param_template& operator=(template_sel other_value);
UDP__ENCAP__Param_template& operator=(int other_value);
UDP__ENCAP__Param_template& operator=(UDP__ENCAP__Param::enum_type other_value);
UDP__ENCAP__Param_template& operator=(const UDP__ENCAP__Param& other_value);
UDP__ENCAP__Param_template& operator=(const OPTIONAL<UDP__ENCAP__Param>& other_value);
UDP__ENCAP__Param_template& operator=(const UDP__ENCAP__Param_template& other_value);

boolean match(UDP__ENCAP__Param::enum_type other_value, boolean legacy = FALSE) const;
boolean match(const UDP__ENCAP__Param& other_value, boolean legacy = FALSE) const;
UDP__ENCAP__Param::enum_type valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
UDP__ENCAP__Param_template& list_item(unsigned int list_index);
void log() const;
void log_match(const UDP__ENCAP__Param& match_value, boolean legacy = FALSE) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present(boolean legacy = FALSE) const;
boolean match_omit(boolean legacy = FALSE) const;
...
class ASP__ConnId__ReadyToRelease {
  INTEGER field_connId;
public:
  ASP__ConnId__ReadyToRelease();
  ASP__ConnId__ReadyToRelease(const INTEGER& par_connId);
  ASP__ConnId__ReadyToRelease(const ASP__ConnId__ReadyToRelease& other_value);
  inline boolean is_component() { return FALSE; }
  void clean_up();
  ASP__ConnId__ReadyToRelease& operator=(const ASP__ConnId__ReadyToRelease& other_value);
  boolean operator==(const ASP__ConnId__ReadyToRelease& other_value) const;
  inline boolean operator!=(const ASP__ConnId__ReadyToRelease& other_value) const
    { return !(*this == other_value); }
...
class ASP__ConnId__ReadyToRelease_template : public Base_Template {
struct single_value_struct;
union {
single_value_struct *single_value;
struct {
unsigned int n_values;
ASP__ConnId__ReadyToRelease_template *list_value;
} value_list;
};

void set_specific();
void copy_value(const ASP__ConnId__ReadyToRelease& other_value);
void copy_template(const ASP__ConnId__ReadyToRelease_template& other_value);

public:
ASP__ConnId__ReadyToRelease_template();
ASP__ConnId__ReadyToRelease_template(template_sel other_value);
ASP__ConnId__ReadyToRelease_template(const ASP__ConnId__ReadyToRelease& other_value);
ASP__ConnId__ReadyToRelease_template(const OPTIONAL<ASP__ConnId__ReadyToRelease>& other_value);
ASP__ConnId__ReadyToRelease_template(const ASP__ConnId__ReadyToRelease_template& other_value);
~ASP__ConnId__ReadyToRelease_template();
ASP__ConnId__ReadyToRelease_template& operator=(template_sel other_value);
ASP__ConnId__ReadyToRelease_template& operator=(const ASP__ConnId__ReadyToRelease& other_value);
ASP__ConnId__ReadyToRelease_template& operator=(const OPTIONAL<ASP__ConnId__ReadyToRelease>& other_value);
ASP__ConnId__ReadyToRelease_template& operator=(const ASP__ConnId__ReadyToRelease_template& other_value);
boolean match(const ASP__ConnId__ReadyToRelease& other_value, boolean legacy = FALSE) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
ASP__ConnId__ReadyToRelease valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
ASP__ConnId__ReadyToRelease_template& list_item(unsigned int list_index) const;
INTEGER_template& connId();
const INTEGER_template& connId() const;
int size_of() const;
void log() const;
void log_match(const ASP__ConnId__ReadyToRelease& match_value, boolean legacy = FALSE) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL, boolean legacy = FALSE) const;
...
public:
enum enum_type { ErrorReadingAddress = 0, IPv4 = 1, IPv6 = 2, UNKNOWN_VALUE = 3, UNBOUND_VALUE = 4 };
private:
enum_type enum_value;
...
extern const TTCN_JSONdescriptor_t ConnectionId_json_;
extern const TTCN_OERdescriptor_t ConnectionId_oer_;
...
extern const TTCN_JSONdescriptor_t AssociationId_json_;
extern const TTCN_OERdescriptor_t AssociationId_oer_;
...
extern const TTCN_JSONdescriptor_t HostName_json_;
extern const TTCN_Typedescriptor_t HostName_descr_;
extern const XERdescriptor_t PortNumber_xer_;
extern const TTCN_JSONdescriptor_t PortNumber_json_;
extern const TTCN_OERdescriptor_t PortNumber_oer_;
...
extern const TTCN_JSONdescriptor_t UserData_json_;
extern const TTCN_OERdescriptor_t UserData_oer_;
...
extern const TTCN_JSONdescriptor_t TcpKeepAlive_enable_json_;
extern const TTCN_OERdescriptor_t TcpKeepAlive_enable_oer_;
extern const TTCN_Typedescriptor_t TcpKeepAlive_enable_descr_;
extern const XERdescriptor_t TcpKeepAlive_count_xer_;
extern const TTCN_JSONdescriptor_t TcpKeepAlive_count_json_;
extern const TTCN_OERdescriptor_t TcpKeepAlive_count_oer_;
extern const TTCN_Typedescriptor_t TcpKeepAlive_count_descr_;
extern const XERdescriptor_t TcpKeepAlive_idle_xer_;
extern const TTCN_JSONdescriptor_t TcpKeepAlive_idle_json_;
extern const TTCN_OERdescriptor_t TcpKeepAlive_idle_oer_;
extern const TTCN_Typedescriptor_t TcpKeepAlive_idle_descr_;
extern const XERdescriptor_t TcpKeepAlive_interval_xer_;
extern const TTCN_JSONdescriptor_t TcpKeepAlive_interval_json_;
extern const TTCN_OERdescriptor_t TcpKeepAlive_interval_oer_;
...
extern const TTCN_JSONdescriptor_t ReuseAddress_enable_json_;
extern const TTCN_OERdescriptor_t ReuseAddress_enable_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__data__io__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__data__io__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__association__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__association__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__address__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__address__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__send__failure__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__send__failure__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__peer__error__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__peer__error__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__shutdown__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__shutdown__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__partial__delivery__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__partial__delivery__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__adaptation__layer__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__adaptation__layer__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__authentication__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__authentication__event_oer_;
...
extern const TTCN_JSONdescriptor_t SctpEventHandle_sctp__sender__dry__event_json_;
extern const TTCN_OERdescriptor_t SctpEventHandle_sctp__sender__dry__event_oer_;
...
extern const TTCN_JSONdescriptor_t Linger__opt_l__onoff_json_;
extern const TTCN_OERdescriptor_t Linger__opt_l__onoff_oer_;
extern const TTCN_Typedescriptor_t Linger__opt_l__onoff_descr_;
extern const XERdescriptor_t Linger__opt_l__linger_xer_;
extern const TTCN_JSONdescriptor_t Linger__opt_l__linger_json_;
extern const TTCN_OERdescriptor_t Linger__opt_l__linger_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_SSLv2__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_SSLv2__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_SSLv3__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_SSLv3__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_TLSv1__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__1__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_TLSv1__1__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_TLSv1__2__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_TLSv1__2__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_DTLSv1__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_DTLSv1__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__protocols_DTLSv1__2__supported_json_;
extern const TTCN_OERdescriptor_t SSL__protocols_DTLSv1__2__supported_oer_;
...
extern const TTCN_JSONdescriptor_t SSL__cert__options_ssl__key__file_json_;
...
extern const TTCN_JSONdescriptor_t SSL__cert__options_ssl__certificate__file_json_;
...
extern const TTCN_JSONdescriptor_t SSL__cert__options_ssl__trustedCAlist__file_json_;
...
extern const TTCN_JSONdescriptor_t SSL__cert__options_ssl__cipher__list_json_;
...
extern const TTCN_JSONdescriptor_t SSL__cert__options_ssl__password_json_;
extern const TTCN_Typedescriptor_t SSL__cert__options_ssl__password_descr_;
extern const TTCN_Typedescriptor_t PSK__options_descr_;
extern const XERdescriptor_t PSK__options_psk__identity_xer_;
extern const TTCN_JSONdescriptor_t PSK__options_psk__identity_json_;
extern const TTCN_Typedescriptor_t PSK__options_psk__identity_descr_;
extern const XERdescriptor_t PSK__options_psk__identity__hint_xer_;
extern const TTCN_JSONdescriptor_t PSK__options_psk__identity__hint_json_;
extern const TTCN_Typedescriptor_t PSK__options_psk__identity__hint_descr_;
extern const XERdescriptor_t PSK__options_psk__key_xer_;
extern const TTCN_JSONdescriptor_t PSK__options_psk__key_json_;
extern const TTCN_Typedescriptor_t PSK__options_psk__key_descr_;
extern const TTCN_Typedescriptor_t MTU__discover_descr_;
...
extern const TTCN_JSONdescriptor_t HostList_0_json_;
extern const TTCN_Typedescriptor_t HostList_0_descr_;
extern const XERdescriptor_t Option_sctpEINConfigGroup_xer_;
extern const TTCN_JSONdescriptor_t Option_sctpEINConfigGroup_json_;
extern const TTCN_OERdescriptor_t Option_sctpEINConfigGroup_oer_;
extern const TTCN_Typedescriptor_t Option_sctpEINConfigGroup_descr_;
extern const XERdescriptor_t Option_no__delay_xer_;
extern const TTCN_JSONdescriptor_t Option_no__delay_json_;
extern const TTCN_OERdescriptor_t Option_no__delay_oer_;
extern const TTCN_Typedescriptor_t Option_no__delay_descr_;
extern const XERdescriptor_t Option_dtlsSrtpProfiles_xer_;
extern const TTCN_JSONdescriptor_t Option_dtlsSrtpProfiles_json_;
extern const TTCN_Typedescriptor_t Option_dtlsSrtpProfiles_descr_;
extern const XERdescriptor_t Option_freebind_xer_;
extern const TTCN_JSONdescriptor_t Option_freebind_json_;
extern const TTCN_OERdescriptor_t Option_freebind_oer_;
...
extern const TTCN_JSONdescriptor_t Option_alpn__list_0_json_;
extern const TTCN_Typedescriptor_t Option_alpn__list_0_descr_;
extern const XERdescriptor_t Option_tls__hostname_xer_;
extern const TTCN_JSONdescriptor_t Option_tls__hostname_json_;
extern const TTCN_Typedescriptor_t Option_tls__hostname_descr_;
extern const TTCN_Typedescriptor_t UDP__ENCAP__Param_descr_;
extern const XERdescriptor_t Option_dscp_xer_;
extern const TTCN_JSONdescriptor_t Option_dscp_json_;
extern const TTCN_OERdescriptor_t Option_dscp_oer_;
extern const TTCN_Typedescriptor_t Option_dscp_descr_;
extern const TTCN_Typedescriptor_t OptionList_descr_;
extern const XERdescriptor_t ASP__Send_connId_xer_;
extern const TTCN_JSONdescriptor_t ASP__Send_connId_json_;
extern const TTCN_OERdescriptor_t ASP__Send_connId_oer_;
extern const TTCN_Typedescriptor_t ASP__Send_connId_descr_;
extern const XERdescriptor_t ASP__Send_msg_xer_;
extern const TTCN_JSONdescriptor_t ASP__Send_msg_json_;
extern const TTCN_OERdescriptor_t ASP__Send_msg_oer_;
...
extern const TTCN_JSONdescriptor_t ASP__SendTo_connId_json_;
extern const TTCN_OERdescriptor_t ASP__SendTo_connId_oer_;
extern const TTCN_Typedescriptor_t ASP__SendTo_connId_descr_;
extern const XERdescriptor_t ASP__SendTo_remName_xer_;
extern const TTCN_JSONdescriptor_t ASP__SendTo_remName_json_;
extern const TTCN_Typedescriptor_t ASP__SendTo_remName_descr_;
extern const XERdescriptor_t ASP__SendTo_remPort_xer_;
extern const TTCN_JSONdescriptor_t ASP__SendTo_remPort_json_;
extern const TTCN_OERdescriptor_t ASP__SendTo_remPort_oer_;
extern const TTCN_Typedescriptor_t ASP__SendTo_remPort_descr_;
extern const XERdescriptor_t ASP__SendTo_msg_xer_;
extern const TTCN_JSONdescriptor_t ASP__SendTo_msg_json_;
extern const TTCN_OERdescriptor_t ASP__SendTo_msg_oer_;
...
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_connId_json_;
extern const TTCN_OERdescriptor_t ASP__RecvFrom_connId_oer_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_connId_descr_;
extern const XERdescriptor_t ASP__RecvFrom_remName_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_remName_json_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_remName_descr_;
extern const XERdescriptor_t ASP__RecvFrom_remPort_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_remPort_json_;
extern const TTCN_OERdescriptor_t ASP__RecvFrom_remPort_oer_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_remPort_descr_;
extern const XERdescriptor_t ASP__RecvFrom_locName_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_locName_json_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_locName_descr_;
extern const XERdescriptor_t ASP__RecvFrom_locPort_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_locPort_json_;
extern const TTCN_OERdescriptor_t ASP__RecvFrom_locPort_oer_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_locPort_descr_;
extern const XERdescriptor_t ASP__RecvFrom_userData_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_userData_json_;
extern const TTCN_OERdescriptor_t ASP__RecvFrom_userData_oer_;
extern const TTCN_Typedescriptor_t ASP__RecvFrom_userData_descr_;
extern const XERdescriptor_t ASP__RecvFrom_msg_xer_;
extern const TTCN_JSONdescriptor_t ASP__RecvFrom_msg_json_;
extern const TTCN_OERdescriptor_t ASP__RecvFrom_msg_oer_;
...
extern const XERdescriptor_t ASP__ConnId__ReadyToRelease_connId_xer_;
extern const TTCN_JSONdescriptor_t ASP__ConnId__ReadyToRelease_connId_json_;
extern const TTCN_OERdescriptor_t ASP__ConnId__ReadyToRelease_connId_oer_;
extern const TTCN_Typedescriptor_t ASP__ConnId__ReadyToRelease_connId_descr_;
extern const TTCN_Typedescriptor_t ASP__ConnId__ReadyToRelease_descr_;
...
extern const TTCN_JSONdescriptor_t IPL4__ParamResult_userData_json_;
extern const TTCN_OERdescriptor_t IPL4__ParamResult_userData_oer_;
...
extern const TTCN_JSONdescriptor_t IPL4__ParamResult_parentIdx_json_;
extern const TTCN_OERdescriptor_t IPL4__ParamResult_parentIdx_oer_;
...
extern const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_localKey_json_;
extern const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_localKey_oer_;
...
extern const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_remoteKey_json_;
extern const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_remoteKey_oer_;
...
extern const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_localSalt_json_;
extern const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_localSalt_oer_;
...
extern const TTCN_JSONdescriptor_t IPL4__SrtpKeysAndSalts_remoteSalt_json_;
extern const TTCN_OERdescriptor_t IPL4__SrtpKeysAndSalts_remoteSalt_oer_;
