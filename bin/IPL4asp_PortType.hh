...
IPL4asp__Types::ASP__ConnId__ReadyToRelease *message_2;
};
...
alt_status receive(const IPL4asp__Types::ASP__ConnId__ReadyToRelease_template& value_template, IPL4asp__Types::ASP__ConnId__ReadyToRelease *value_redirect, const COMPONENT_template& sender_template, COMPONENT *sender_ptr, Index_Redirect*);
alt_status check_receive(const IPL4asp__Types::ASP__ConnId__ReadyToRelease_template& value_template, IPL4asp__Types::ASP__ConnId__ReadyToRelease *value_redirect, const COMPONENT_template& sender_template, COMPONENT *sender_ptr, Index_Redirect*);
alt_status trigger(const IPL4asp__Types::ASP__ConnId__ReadyToRelease_template& value_template, IPL4asp__Types::ASP__ConnId__ReadyToRelease *value_redirect, const COMPONENT_template& sender_template, COMPONENT *sender_ptr, Index_Redirect*);
private:
...
void incoming_message(const IPL4asp__Types::ASP__ConnId__ReadyToRelease& incoming_par, component sender_component);
protected:
...
void incoming_message(const IPL4asp__Types::ASP__ConnId__ReadyToRelease& incoming_par);
...
extern Socket__API__Definitions::Result f__IPL4__port__settings(IPL4asp__PT& portRef, const CHARSTRING& param__name, const CHARSTRING& param__value);
extern Socket__API__Definitions::Result f__IPL4__ConnId__release(IPL4asp__PT& portRef, const INTEGER& connId);
...
extern Socket__API__Definitions::Extended__Result f__IPL4__getOpt(IPL4asp__PT& portRef, const IPL4asp__Types::Option& option, const INTEGER& connId, const Socket__API__Definitions::ProtoTuple& proto);
...
extern Socket__API__Definitions::Extended__Result f__IPL4__getConnectedPathMTU(IPL4asp__PT& portRef, const INTEGER& connId, const Socket__API__Definitions::ProtoTuple& proto);
...
extern const INTEGER& f__IPL4__getOpt_connId_defval;
extern const Socket__API__Definitions::ProtoTuple& f__IPL4__getOpt_proto_defval;
extern const Socket__API__Definitions::ProtoTuple& f__IPL4__close_proto_defval;
extern const INTEGER& f__IPL4__getConnectedPathMTU_connId_defval;
extern const Socket__API__Definitions::ProtoTuple& f__IPL4__getConnectedPathMTU_proto_defval;
